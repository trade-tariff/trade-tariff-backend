...
\restrict HLdZr8K8odoprqGIwHGK8zHOUdVciqNxpd9GuAgNqLzIZXRmuUhPWX4XMbhh56X
...
CREATE TABLE public.user_data_exports (
    ...
    export_type text,
    exporter_class text,
    exporter_args jsonb DEFAULT '{}'::jsonb,
    s3_key text,
    file_name text,
    status text,
    created_at timestamp without time zone,
...
--
-- Name: user_data_exports_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.user_data_exports ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.user_data_exports_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: geo_area_memberships_group_sid_validity_index; Type: INDEX; Schema: uk; Owner: -
--
...
--
-- Name: measure_components_covering_index; Type: INDEX; Schema: uk; Owner: -
--
...
--
-- Name: tariff_knowledge_public_atar_rulings_goods_nomenclature_item_id; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_public_atar_rulings_goods_nomenclature_item_id ON uk.tariff_knowledge_public_atar_rulings USING btree (goods_nomenclature_item_id);
...
ALTER TABLE ONLY public.user_data_exports
    ADD CONSTRAINT user_data_exports_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
...
\unrestrict HLdZr8K8odoprqGIwHGK8zHOUdVciqNxpd9GuAgNqLzIZXRmuUhPWX4XMbhh56X
...
INSERT INTO "schema_migrations" ("filename") VALUES ('20260506120000_add_oid_covering_column_to_fts_oplog_indexes.rb');
...
INSERT INTO "schema_migrations" ("filename") VALUES ('20260529120000_add_geographical_area_memberships_group_sid_index.rb');
...
INSERT INTO "schema_migrations" ("filename") VALUES ('20260812000001_create_evaluation_gold_queries.rb');