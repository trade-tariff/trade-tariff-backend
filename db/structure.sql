...
--
-- Name: user_delta_preferences; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.user_delta_preferences (
    id integer NOT NULL,
    user_id integer NOT NULL,
...
--
-- Name: user_delta_preferences_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.user_delta_preferences ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.user_delta_preferences_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: user_delta_preferences user_delta_preferences_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_delta_preferences
    ADD CONSTRAINT user_delta_preferences_pkey PRIMARY KEY (id);
...
--
-- Name: user_cc_unique_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX user_cc_unique_idx ON public.user_delta_preferences USING btree (user_id, commodity_code);
...
--
-- Name: user_delta_preferences user_delta_preferences_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_delta_preferences
    ADD CONSTRAINT user_delta_preferences_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
