...
\restrict eWuhnkbF0jDutjNYh3UfKOVtrcLt8q7SJLJfd5GoJp2mEpYKfOfXpQTxufEkNMh
...
CREATE TABLE uk.customs_tariff_chapter_notes (
    id integer NOT NULL,
    customs_tariff_update_version text CONSTRAINT customs_tariff_chapter_note_customs_tariff_update_vers_not_null NOT NULL,
...
CREATE TABLE uk.customs_tariff_general_rules (
    id integer NOT NULL,
    customs_tariff_update_version text CONSTRAINT customs_tariff_general_rule_customs_tariff_update_vers_not_null NOT NULL,
...
CREATE TABLE uk.customs_tariff_section_notes (
    id integer NOT NULL,
    customs_tariff_update_version text CONSTRAINT customs_tariff_section_note_customs_tariff_update_vers_not_null NOT NULL,
...
\unrestrict eWuhnkbF0jDutjNYh3UfKOVtrcLt8q7SJLJfd5GoJp2mEpYKfOfXpQTxufEkNMh
...
INSERT INTO "schema_migrations" ("filename") VALUES ('0001_create_uk_schema.rb');
