...
--
-- Name: tariff_knowledge_declarable_contexts; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.tariff_knowledge_declarable_contexts (
    goods_nomenclature_sid integer NOT NULL,
    goods_nomenclature_item_id character varying(10) NOT NULL,
    content text NOT NULL,
...
--
-- Name: tariff_knowledge_declarable_contexts tariff_knowledge_declarable_contexts_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.tariff_knowledge_declarable_contexts
    ADD CONSTRAINT tariff_knowledge_declarable_contexts_pkey PRIMARY KEY (goods_nomenclature_sid);
...
--
-- Name: tariff_knowledge_declarable_contexts_approved_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_declarable_contexts_approved_index ON uk.tariff_knowledge_declarable_contexts USING btree (approved) WHERE (approved = true);


--
-- Name: tariff_knowledge_declarable_contexts_expired_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_declarable_contexts_expired_index ON uk.tariff_knowledge_declarable_contexts USING btree (expired) WHERE (expired = true);


--
-- Name: tariff_knowledge_declarable_contexts_goods_nomenclature_item_id; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_declarable_contexts_goods_nomenclature_item_id ON uk.tariff_knowledge_declarable_contexts USING btree (goods_nomenclature_item_id);


--
-- Name: tariff_knowledge_declarable_contexts_needs_review_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_declarable_contexts_needs_review_index ON uk.tariff_knowledge_declarable_contexts USING btree (needs_review) WHERE (needs_review = true);
...
--
-- Name: tariff_knowledge_nodes_approved_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_nodes_approved_index ON uk.tariff_knowledge_nodes USING btree (approved) WHERE (approved = true);
...
--
-- Name: tariff_knowledge_nodes_needs_review_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_nodes_needs_review_index ON uk.tariff_knowledge_nodes USING btree (needs_review) WHERE (needs_review = true);
...
INSERT INTO "schema_migrations" ("filename") VALUES ('20260604120000_create_tariff_knowledge_graph.rb');
