...
--
-- Name: green_lanes_measure_exemptions; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.green_lanes_measure_exemptions (
    id integer NOT NULL,
    exemption_id integer NOT NULL,
    green_lanes_measure_id integer,
    measure_sid integer,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    CONSTRAINT green_lanes_measure_exemptions_check CHECK (((measure_sid IS NULL) <> (green_lanes_measure_id IS NULL)))
);


--
-- Name: green_lanes_measure_exemptions_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.green_lanes_measure_exemptions ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.green_lanes_measure_exemptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: green_lanes_measure_exemptions green_lanes_measure_exemptions_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.green_lanes_measure_exemptions
    ADD CONSTRAINT green_lanes_measure_exemptions_pkey PRIMARY KEY (id);
...
CREATE UNIQUE INDEX green_lanes_measures_category_assessment_id_goods_nomenclature_ ON uk.green_lanes_measures USING btree (category_assessment_id, goods_nomenclature_item_id);
...
--
-- Name: green_lanes_measure_exemptions green_lanes_measure_exemptions_exemption_id_fkey; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.green_lanes_measure_exemptions
    ADD CONSTRAINT green_lanes_measure_exemptions_exemption_id_fkey FOREIGN KEY (exemption_id) REFERENCES uk.green_lanes_exemptions(id);


--
-- Name: green_lanes_measure_exemptions green_lanes_measure_exemptions_green_lanes_measure_id_fkey; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.green_lanes_measure_exemptions
    ADD CONSTRAINT green_lanes_measure_exemptions_green_lanes_measure_id_fkey FOREIGN KEY (green_lanes_measure_id) REFERENCES uk.green_lanes_measures(id);
...
INSERT INTO "schema_migrations" ("filename") VALUES ('20240425140515_add_green_lanes_measures_tables.rb');