...
--
-- Name: enquiry_form_submissions; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.enquiry_form_submissions (
    id integer NOT NULL,
...
--
-- Name: enquiry_form_submissions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.enquiry_form_submissions ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.enquiry_form_submissions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: enquiry_form_submissions enquiry_form_submissions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.enquiry_form_submissions
    ADD CONSTRAINT enquiry_form_submissions_pkey PRIMARY KEY (id);


--
-- Name: enquiry_form_submissions enquiry_form_submissions_reference_number_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.enquiry_form_submissions
    ADD CONSTRAINT enquiry_form_submissions_reference_number_key UNIQUE (reference_number);
...
INSERT INTO "schema_migrations" ("filename") VALUES ('20250710161832_create_enquiry_form_submissions.rb');