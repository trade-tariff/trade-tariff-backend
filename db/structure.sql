...
--
-- Name: change_notifications; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: change_notifications_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.change_notifications ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.change_notifications_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: change_notifications change_notifications_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.change_notifications
    ADD CONSTRAINT change_notifications_pkey PRIMARY KEY (id);
...
--
-- Name: change_notifications change_notifications_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.change_notifications
    ADD CONSTRAINT change_notifications_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
...
INSERT INTO "schema_migrations" ("filename") VALUES ('20250514093320_create_change_notifications.rb');