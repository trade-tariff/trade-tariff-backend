...
--
-- Name: guides_goods_nomenclatures; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.guides_goods_nomenclatures (
    id integer NOT NULL,
...
--
-- Name: guides_goods_nomenclatures_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.guides_goods_nomenclatures ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.guides_goods_nomenclatures_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: news_collections; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.news_collections (
    id integer NOT NULL,
...
--
-- Name: news_collections_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.news_collections ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.news_collections_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: news_collections_news_items; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.news_collections_news_items (
...
ALTER TABLE public.news_items ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: quota_closed_and_transferred_events_oplog; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.quota_closed_and_transferred_events_oplog (
    oid integer NOT NULL,
    operation character varying(1) DEFAULT 'C'::character varying,
    operation_date date,
...
--
-- Name: quota_closed_and_transferred_events; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.quota_closed_and_transferred_events AS
 SELECT quota_closed_and_transferred_events1.oid,
   ...
   FROM public.quota_closed_and_transferred_events_oplog quota_closed_and_transferred_events1
  WHERE ((quota_closed_and_transferred_events1.oid IN ( SELECT max(quota_closed_and_transferred_events2.oid) AS max
           FROM public.quota_closed_and_transferred_events_oplog quota_closed_and_transferred_events2
...
--
-- Name: quota_closed_and_transferred_events_oplog_oid_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.quota_closed_and_transferred_events_oplog ALTER COLUMN oid ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.quota_closed_and_transferred_events_oplog_oid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: changes changes_upsert_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: guides_goods_nomenclatures guides_goods_nomenclatures_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.guides_goods_nomenclatures
...
--
-- Name: news_collections news_collections_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: news_collections_news_items news_collections_news_items_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: news_collections news_collections_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: quota_closed_and_transferred_events_oplog quota_closed_and_transferred_events_oplog_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.quota_closed_and_transferred_events_oplog
...
--
-- Name: guides_goods_nomenclatures_goods_nomenclature_sid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX guides_goods_nomenclatures_goods_nomenclature_sid_index ON public.guides_goods_nomenclatures USING btree (goods_nomenclature_sid);


--
-- Name: guides_goods_nomenclatures_guide_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX guides_goods_nomenclatures_guide_id_index ON public.guides_goods_nomenclatures USING btree (guide_id);
...
--
-- Name: news_collections_news_items_item_id_collection_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX news_collections_news_items_item_id_collection_id_index ON public.news_collections_news_items USING btree (item_id, collection_id);


--
-- Name: news_items_show_on_uk_show_on_xi_show_on_updates_page_show_on_h; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX news_items_show_on_uk_show_on_xi_show_on_updates_page_show_on_h ON public.news_items USING btree (show_on_uk, show_on_xi, show_on_updates_page, show_on_home_page, start_date, end_date);
...
--
-- Name: quota_closed_and_transferred_evt_pk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX quota_closed_and_transferred_evt_pk ON public.quota_closed_and_transferred_events_oplog USING btree (quota_definition_sid, occurrence_timestamp, oid);
...
--
-- Name: news_collections_news_items news_collections_news_items_collection_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.news_collections_news_items
    ADD CONSTRAINT news_collections_news_items_collection_id_fkey FOREIGN KEY (collection_id) REFERENCES public.news_collections(id);


--
-- Name: news_collections_news_items news_collections_news_items_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
