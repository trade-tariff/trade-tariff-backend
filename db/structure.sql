...
--
-- Name: exchange_rate_country_histories; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.exchange_rate_country_histories (
    id integer NOT NULL,
    country character varying(200) NOT NULL,
    country_code character varying(10) NOT NULL,
    currency_code character varying(10) NOT NULL,
    currency_description character varying(200) NOT NULL,
...
--
-- Name: exchange_rate_country_histories_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.exchange_rate_country_histories ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.exchange_rate_country_histories_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: exchange_rate_country_histories exchange_rate_country_histories_country_code_key; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.exchange_rate_country_histories
    ADD CONSTRAINT exchange_rate_country_histories_country_code_key UNIQUE (country_code);


--
-- Name: exchange_rate_country_histories exchange_rate_country_histories_country_key; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.exchange_rate_country_histories
    ADD CONSTRAINT exchange_rate_country_histories_country_key UNIQUE (country);


--
-- Name: exchange_rate_country_histories exchange_rate_country_histories_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.exchange_rate_country_histories
    ADD CONSTRAINT exchange_rate_country_histories_pkey PRIMARY KEY (id);
...
--
-- Name: exchange_rate_country_histories_country_country_code_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX exchange_rate_country_histories_country_country_code_index ON uk.exchange_rate_country_histories USING btree (country, country_code);


--
-- Name: exchange_rate_country_histories_country_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX exchange_rate_country_histories_country_index ON uk.exchange_rate_country_histories USING btree (country);
