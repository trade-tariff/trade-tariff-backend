...
CREATE TABLE uk.green_lanes_themes (
    ...
    category_implied integer NOT NULL
);
...
--
-- Name: green_lanes_themes green_lanes_themes_section_key; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.green_lanes_themes
    ADD CONSTRAINT green_lanes_themes_section_key UNIQUE (section);
...
CREATE UNIQUE INDEX green_lanes_category_assessments_measure_type_id_regulation_id_ ON uk.green_lanes_category_assessments USING btree (measure_type_id, regulation_id);
