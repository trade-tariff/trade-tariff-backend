...
--
-- Name: deltas; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.deltas (
    ...
    end_line boolean,
    delta_type character varying(255),
    delta_date date
);


--
-- Name: deltas_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.deltas ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.deltas_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: deltas deltas_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
