...
CREATE MATERIALIZED VIEW uk.goods_nomenclature_tree_nodes AS
 WITH tree_nodes AS (
         ...
         SELECT DISTINCT ON (t_1.goods_nomenclature_indent_sid) t_1.goods_nomenclature_indent_sid,
           ...
           FROM (tree_nodes t_1
             LEFT JOIN tree_nodes s ON (((s.depth = t_1.depth) AND ((s."position" / 10000000000) = (t_1."position" / 10000000000)) AND (s."position" > t_1."position") AND ((t_1.validity_end_date IS NULL) OR (s.validity_start_date <= t_1.validity_end_date)) AND ((s.validity_end_date IS NULL) OR (s.validity_end_date >= t_1.validity_start_date)))))
...
--
-- Name: measures_ordernumber_pattern_idx; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX measures_ordernumber_pattern_idx ON uk.measures USING btree (ordernumber varchar_pattern_ops);
...
=======
>>>>>>> 1dba2dc9f (Refactor goods nomenclature query to remove subquery)
...
INSERT INTO "schema_migrations" ("filename") VALUES ('20260413120000_add_ordernumber_pattern_ops_index_to_measures.rb');
