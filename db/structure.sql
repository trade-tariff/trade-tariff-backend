...
--
-- Name: admin_configurations_oplog; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.admin_configurations_oplog (
    oid integer NOT NULL,
    name text NOT NULL,
...
--
-- Name: admin_configurations; Type: MATERIALIZED VIEW; Schema: uk; Owner: -
--

CREATE MATERIALIZED VIEW uk.admin_configurations AS
 SELECT o.oid,
    o.name,
    o.value,
    o.config_type,
   ...
   FROM (uk.admin_configurations_oplog o
     JOIN ( SELECT admin_configurations_oplog.name,
            max(admin_configurations_oplog.oid) AS max_oid
           FROM uk.admin_configurations_oplog
          GROUP BY admin_configurations_oplog.name) latest ON ((o.oid = latest.max_oid)))
  WHERE ((o.operation)::text <> 'D'::text)
  WITH NO DATA;


--
-- Name: admin_configurations_oplog_oid_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.admin_configurations_oplog ALTER COLUMN oid ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.admin_configurations_oplog_oid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: goods_nomenclature_labels_oplog; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.goods_nomenclature_labels_oplog (
    oid integer NOT NULL,
    goods_nomenclature_sid integer NOT NULL,
    goods_nomenclature_type character varying(50) CONSTRAINT goods_nomenclature_labels_oplo_goods_nomenclature_type_not_null NOT NULL,
    goods_nomenclature_item_id character varying(10),
    ...
    operation_date date NOT NULL,
    created_at timestamp without time zone NOT NULL,
    filename text DEFAULT 'n/a'::text
);


--
-- Name: goods_nomenclature_labels; Type: MATERIALIZED VIEW; Schema: uk; Owner: -
--

CREATE MATERIALIZED VIEW uk.goods_nomenclature_labels AS
 SELECT o.oid,
    o.goods_nomenclature_sid,
    o.goods_nomenclature_type,
    o.goods_nomenclature_item_id,
    o.producline_suffix,
    o.labels,
    o.validity_start_date,
    o.validity_end_date,
    o.operation,
    o.operation_date,
    o.created_at,
   ...
   FROM (uk.goods_nomenclature_labels_oplog o
     JOIN ( SELECT goods_nomenclature_labels_oplog.goods_nomenclature_sid,
            max(goods_nomenclature_labels_oplog.oid) AS max_oid
           FROM uk.goods_nomenclature_labels_oplog
          GROUP BY goods_nomenclature_labels_oplog.goods_nomenclature_sid) latest ON ((o.oid = latest.max_oid)))
  WHERE ((o.operation)::text <> 'D'::text)
  WITH NO DATA;


--
-- Name: goods_nomenclature_labels_oplog_oid_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.goods_nomenclature_labels_oplog ALTER COLUMN oid ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.goods_nomenclature_labels_oplog_oid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE uk.tariff_update_conformance_errors (
    id integer NOT NULL,
    tariff_update_filename text CONSTRAINT tariff_update_conformance_error_tariff_update_filename_not_null NOT NULL,
    model_name text NOT NULL,
...
--
-- Name: admin_configurations_oplog admin_configurations_oplog_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.admin_configurations_oplog
    ADD CONSTRAINT admin_configurations_oplog_pkey PRIMARY KEY (oid);
...
--
-- Name: goods_nomenclature_labels_oplog goods_nomenclature_labels_oplog_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.goods_nomenclature_labels_oplog
    ADD CONSTRAINT goods_nomenclature_labels_oplog_pkey PRIMARY KEY (oid);
...
--
-- Name: idx_ac_mv_area; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX idx_ac_mv_area ON uk.admin_configurations USING btree (area);


--
-- Name: idx_ac_mv_name; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX idx_ac_mv_name ON uk.admin_configurations USING btree (name);


--
-- Name: idx_ac_mv_value_gin; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX idx_ac_mv_value_gin ON uk.admin_configurations USING gin (value);
...
--
-- Name: labels_created_at_idx; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX labels_created_at_idx ON uk.goods_nomenclature_labels USING btree (created_at DESC);
...
--
-- Name: uk_admin_configurations_oplog_area_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX uk_admin_configurations_oplog_area_index ON uk.admin_configurations_oplog USING btree (area);


--
-- Name: uk_admin_configurations_oplog_name__oid__DESC_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX "uk_admin_configurations_oplog_name__oid__DESC_index" ON uk.admin_configurations_oplog USING btree (name, oid DESC);


--
-- Name: uk_admin_configurations_oplog_name_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX uk_admin_configurations_oplog_name_index ON uk.admin_configurations_oplog USING btree (name);


--
-- Name: uk_goods_nomenclature_labels_oplog_created_at_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX uk_goods_nomenclature_labels_oplog_created_at_index ON uk.goods_nomenclature_labels_oplog USING btree (created_at);


--
-- Name: uk_goods_nomenclature_labels_oplog_goods_nomenclature_sid_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX uk_goods_nomenclature_labels_oplog_goods_nomenclature_sid_index ON uk.goods_nomenclature_labels_oplog USING btree (goods_nomenclature_sid);


--
-- Name: uk_goods_nomenclature_labels_oplog_labels_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX uk_goods_nomenclature_labels_oplog_labels_index ON uk.goods_nomenclature_labels_oplog USING gin (labels);


--
-- Name: uk_goods_nomenclature_labels_oplog_validity_start_date_validity; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX uk_goods_nomenclature_labels_oplog_validity_start_date_validity ON uk.goods_nomenclature_labels_oplog USING btree (validity_start_date, validity_end_date);
