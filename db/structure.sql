...
--
-- Name: search_analytics_latest_state(bigint, bigint); Type: FUNCTION; Schema: uk; Owner: -
--

CREATE FUNCTION uk.search_analytics_latest_state(a bigint, b bigint) RETURNS bigint
...
--
-- Name: search_analytics_latest_state(bigint); Type: AGGREGATE; Schema: uk; Owner: -
--

CREATE AGGREGATE uk.search_analytics_latest_state(bigint) (
    SFUNC = uk.search_analytics_latest_state,
    STYPE = bigint,
    COMBINEFUNC = uk.search_analytics_latest_state,
    PARALLEL = safe
);
...
--
-- Name: search_analytics_journey_days; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.search_analytics_journey_days (
    read_model_id integer NOT NULL,
    reporting_date date NOT NULL,
    journey_key bytea NOT NULL,
    all_hours bigint NOT NULL,
    classic_hours bigint NOT NULL,
    internal_hours bigint NOT NULL,
    terminal bigint,
...
--
-- Name: search_analytics_journey_rollups; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.search_analytics_journey_rollups (
    read_model_id integer NOT NULL,
    reporting_date date NOT NULL,
    view text NOT NULL,
    ...
    nonterminal bigint NOT NULL,
    unknown bigint NOT NULL,
    selected bigint NOT NULL,
    zero_result bigint NOT NULL
);


--
-- Name: search_analytics_multi_day_observations; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.search_analytics_multi_day_observations (
    read_model_id integer NOT NULL,
    reporting_date date NOT NULL,
    journey_key bytea NOT NULL,
    all_hours bigint NOT NULL,
...
--
-- Name: search_analytics_read_models; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.search_analytics_read_models (
    id integer NOT NULL,
    service text NOT NULL,
...
--
-- Name: search_analytics_read_models_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.search_analytics_read_models ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.search_analytics_read_models_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: search_analytics_read_models search_analytics_read_models_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.search_analytics_read_models
    ADD CONSTRAINT search_analytics_read_models_pkey PRIMARY KEY (id);
...
--
-- Name: idx_search_analytics_journey_days_date; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX idx_search_analytics_journey_days_date ON uk.search_analytics_journey_days USING btree (read_model_id, reporting_date);


--
-- Name: idx_search_analytics_journey_days_identity; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX idx_search_analytics_journey_days_identity ON uk.search_analytics_journey_days USING btree (read_model_id, journey_key, reporting_date);


--
-- Name: idx_search_analytics_journey_rollups_identity; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX idx_search_analytics_journey_rollups_identity ON uk.search_analytics_journey_rollups USING btree (read_model_id, reporting_date, view, bucket_size, bucket);


--
-- Name: idx_search_analytics_multi_day_date; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX idx_search_analytics_multi_day_date ON uk.search_analytics_multi_day_observations USING btree (read_model_id, reporting_date);


--
-- Name: idx_search_analytics_multi_day_identity; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX idx_search_analytics_multi_day_identity ON uk.search_analytics_multi_day_observations USING btree (read_model_id, journey_key, reporting_date);


--
-- Name: idx_search_analytics_read_models_latest; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX idx_search_analytics_read_models_latest ON uk.search_analytics_read_models USING btree (service, region, built_at);
...
--
-- Name: search_analytics_journey_days search_analytics_journey_days_read_model_id_fkey; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.search_analytics_journey_days
    ADD CONSTRAINT search_analytics_journey_days_read_model_id_fkey FOREIGN KEY (read_model_id) REFERENCES uk.search_analytics_read_models(id) ON DELETE CASCADE;


--
-- Name: search_analytics_journey_rollups search_analytics_journey_rollups_read_model_id_fkey; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.search_analytics_journey_rollups
    ADD CONSTRAINT search_analytics_journey_rollups_read_model_id_fkey FOREIGN KEY (read_model_id) REFERENCES uk.search_analytics_read_models(id) ON DELETE CASCADE;


--
-- Name: search_analytics_multi_day_observations search_analytics_multi_day_observations_read_model_id_fkey; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.search_analytics_multi_day_observations
    ADD CONSTRAINT search_analytics_multi_day_observations_read_model_id_fkey FOREIGN KEY (read_model_id) REFERENCES uk.search_analytics_read_models(id) ON DELETE CASCADE;
...
INSERT INTO "schema_migrations" ("filename") VALUES ('20260918120000_create_search_analytics_read_models.rb');
