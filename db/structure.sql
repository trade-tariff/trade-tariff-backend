...
--
-- Name: search_analytics_snapshots; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.search_analytics_snapshots (
    id integer NOT NULL,
...
--
-- Name: search_analytics_snapshots_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.search_analytics_snapshots ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.search_analytics_snapshots_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: search_analytics_snapshots search_analytics_snapshots_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.search_analytics_snapshots
...
--
-- Name: idx_search_analytics_snapshots_unique_window; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_search_analytics_snapshots_unique_window ON public.search_analytics_snapshots USING btree (service, period, view, generated_at);


--
-- Name: public_search_analytics_snapshots_data_through_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX public_search_analytics_snapshots_data_through_index ON public.search_analytics_snapshots USING btree (data_through);


--
-- Name: public_search_analytics_snapshots_generated_at_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX public_search_analytics_snapshots_generated_at_index ON public.search_analytics_snapshots USING btree (generated_at);


--
-- Name: public_search_analytics_snapshots_period_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX public_search_analytics_snapshots_period_index ON public.search_analytics_snapshots USING btree (period);


--
-- Name: public_search_analytics_snapshots_service_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX public_search_analytics_snapshots_service_index ON public.search_analytics_snapshots USING btree (service);


--
-- Name: public_search_analytics_snapshots_view_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX public_search_analytics_snapshots_view_index ON public.search_analytics_snapshots USING btree (view);
