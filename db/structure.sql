...
--
-- Name: reject_search_analytics_result_mutation(); Type: FUNCTION; Schema: uk; Owner: -
--

CREATE FUNCTION uk.reject_search_analytics_result_mutation() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: search_analytics_collections; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.search_analytics_collections (
    id integer NOT NULL,
    service text NOT NULL,
    ...
    status text NOT NULL,
    price_per_gb_usd numeric(20,10) NOT NULL,
    started_at timestamp without time zone NOT NULL,
    finished_at timestamp without time zone,
    error_class text,
    query_results jsonb DEFAULT '{}'::jsonb NOT NULL
);


--
-- Name: search_analytics_collections_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.search_analytics_collections ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.search_analytics_collections_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: search_analytics_days; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.search_analytics_days (
    id integer NOT NULL,
    service text NOT NULL,
    source text NOT NULL,
    reporting_date date NOT NULL,
...
--
-- Name: search_analytics_days_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.search_analytics_days ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.search_analytics_days_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: search_analytics_query_runs; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.search_analytics_query_runs (
    id integer NOT NULL,
    collection_id integer NOT NULL,
    name text NOT NULL,
    query_id text,
...
--
-- Name: search_analytics_query_runs_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.search_analytics_query_runs ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.search_analytics_query_runs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: search_analytics_collections search_analytics_collections_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.search_analytics_collections
    ADD CONSTRAINT search_analytics_collections_pkey PRIMARY KEY (id);


--
-- Name: search_analytics_days search_analytics_days_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.search_analytics_days
    ADD CONSTRAINT search_analytics_days_pkey PRIMARY KEY (id);
...
--
-- Name: search_analytics_query_runs search_analytics_query_runs_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.search_analytics_query_runs
    ADD CONSTRAINT search_analytics_query_runs_pkey PRIMARY KEY (id);


--
-- Name: idx_search_analytics_collection_provenance; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX idx_search_analytics_collection_provenance ON uk.search_analytics_collections USING btree (id, service, source, reporting_date, definition_version);


--
-- Name: idx_search_analytics_day_identity; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX idx_search_analytics_day_identity ON uk.search_analytics_days USING btree (service, source, reporting_date, definition_version);


--
-- Name: idx_search_analytics_result_provenance; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX idx_search_analytics_result_provenance ON uk.search_analytics_collections USING btree (id, service, source, reporting_date, region, log_group_name);


--
-- Name: idx_search_analytics_reusable_query; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX idx_search_analytics_reusable_query ON uk.search_analytics_query_results USING btree (service, source, reporting_date, name, fingerprint);


--
-- Name: idx_search_analytics_running_day; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX idx_search_analytics_running_day ON uk.search_analytics_collections USING btree (service, source, reporting_date, definition_version) WHERE (status = 'running'::text);


--
-- Name: idx_search_analytics_running_window; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX idx_search_analytics_running_window ON uk.search_analytics_collections USING btree (service, source, reporting_date) WHERE (status = 'running'::text);


--
-- Name: search_analytics_query_runs_collection_id_name_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX search_analytics_query_runs_collection_id_name_index ON uk.search_analytics_query_runs USING btree (collection_id, name);


--
-- Name: search_analytics_query_results search_analytics_results_immutable; Type: TRIGGER; Schema: uk; Owner: -
--

CREATE TRIGGER search_analytics_results_immutable BEFORE DELETE OR UPDATE ON uk.search_analytics_query_results FOR EACH ROW EXECUTE FUNCTION uk.reject_search_analytics_result_mutation();


--
-- Name: search_analytics_days fk_search_analytics_day_provenance; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.search_analytics_days
    ADD CONSTRAINT fk_search_analytics_day_provenance FOREIGN KEY (collection_id, service, source, reporting_date, definition_version) REFERENCES uk.search_analytics_collections(id, service, source, reporting_date, definition_version);


--
-- Name: search_analytics_query_results fk_search_analytics_result_provenance; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.search_analytics_query_results
    ADD CONSTRAINT fk_search_analytics_result_provenance FOREIGN KEY (collection_id, service, source, reporting_date, region, log_group_name) REFERENCES uk.search_analytics_collections(id, service, source, reporting_date, region, log_group_name);


--
-- Name: search_analytics_query_runs search_analytics_query_runs_collection_id_fkey; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.search_analytics_query_runs
    ADD CONSTRAINT search_analytics_query_runs_collection_id_fkey FOREIGN KEY (collection_id) REFERENCES uk.search_analytics_collections(id);
...
INSERT INTO "schema_migrations" ("filename") VALUES ('20260915100000_create_search_analytics_daily_facts.rb');
