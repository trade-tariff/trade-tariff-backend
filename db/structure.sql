...
CREATE TABLE uk.search_analytics_snapshots (
    id integer NOT NULL,
    ...
    data_through timestamp without time zone NOT NULL,
...
--
-- Name: search_analytics_snapshots_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.search_analytics_snapshots ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.search_analytics_snapshots_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: tariff_changes_job_statuses; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.tariff_changes_job_statuses (
    id integer NOT NULL,
    operation_date date NOT NULL,
    changes_generated_at timestamp without time zone,
...
--
-- Name: tariff_changes_job_statuses_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.tariff_changes_job_statuses ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.tariff_changes_job_statuses_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: user_subscription_targets; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.user_subscription_targets (
    id integer NOT NULL,
    user_subscriptions_uuid uuid NOT NULL,
...
--
-- Name: user_subscription_targets_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.user_subscription_targets ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.user_subscription_targets_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: admin_configurations; Type: TABLE; Schema: uk; Owner: -
--
...
--
-- Name: admin_configurations_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--
...
--
-- Name: cds_update_notifications; Type: TABLE; Schema: uk; Owner: -
--
...
--
-- Name: cds_update_notifications_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--
...
--
-- Name: customs_tariff_chapter_notes; Type: TABLE; Schema: uk; Owner: -
--
...
--
-- Name: customs_tariff_chapter_notes_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--
...
--
-- Name: customs_tariff_general_rules; Type: TABLE; Schema: uk; Owner: -
--
...
--
-- Name: customs_tariff_general_rules_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--
...
--
-- Name: customs_tariff_section_notes; Type: TABLE; Schema: uk; Owner: -
--
...
--
-- Name: customs_tariff_section_notes_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--
...
--
-- Name: customs_tariff_updates; Type: TABLE; Schema: uk; Owner: -
--
...
--
-- Name: description_intercepts; Type: TABLE; Schema: uk; Owner: -
--
...
--
-- Name: description_intercepts_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--
...
--
-- Name: evaluation_experiments; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.evaluation_experiments (
    id integer NOT NULL,
    name text NOT NULL,
    description text,
    enabled boolean DEFAULT true NOT NULL,
    configuration_overrides jsonb DEFAULT '{}'::jsonb NOT NULL,
    default_scope jsonb DEFAULT '{}'::jsonb NOT NULL,
...
--
-- Name: evaluation_experiments_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.evaluation_experiments ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.evaluation_experiments_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: evaluation_results; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.evaluation_results (
    id integer NOT NULL,
    ...
    final_code text,
    final_rank integer,
    gold_in_top1 boolean DEFAULT false NOT NULL,
...
--
-- Name: evaluation_results_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.evaluation_results ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.evaluation_results_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: evaluation_runs; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.evaluation_runs (
    id integer NOT NULL,
    experiment_id integer NOT NULL,
    status text NOT NULL,
    triggered_by text NOT NULL,
    configuration_digest character varying(16),
    ...
    total_provider_calls integer DEFAULT 0 NOT NULL,
    total_latency_seconds numeric(10,2),
...
--
-- Name: evaluation_runs_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.evaluation_runs ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.evaluation_runs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: goods_nomenclature_intercepts; Type: TABLE; Schema: uk; Owner: -
--
...
--
-- Name: goods_nomenclature_labels; Type: TABLE; Schema: uk; Owner: -
--
...
--
-- Name: tariff_changes; Type: TABLE; Schema: uk; Owner: -
--
...
--
-- Name: tariff_changes_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--
...
--
-- Name: tariff_knowledge_compressed_notes; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.tariff_knowledge_compressed_notes (
    goods_nomenclature_sid integer CONSTRAINT tariff_knowledge_compressed_not_goods_nomenclature_sid_not_null NOT NULL,
    goods_nomenclature_item_id character varying(10) CONSTRAINT tariff_knowledge_compressed_goods_nomenclature_item_id_not_null NOT NULL,
    producline_suffix character varying(2) NOT NULL,
    goods_nomenclature_type character varying(50) CONSTRAINT tariff_knowledge_compressed_no_goods_nomenclature_type_not_null NOT NULL,
    content text NOT NULL,
...
--
-- Name: tariff_knowledge_edges; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.tariff_knowledge_edges (
    id integer NOT NULL,
...
--
-- Name: tariff_knowledge_edges_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.tariff_knowledge_edges ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.tariff_knowledge_edges_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: tariff_knowledge_nodes; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.tariff_knowledge_nodes (
    id integer NOT NULL,
    ...
    goods_nomenclature_sid integer,
    goods_nomenclature_item_id character varying(10),
    producline_suffix character varying(2),
    goods_nomenclature_type character varying(50),
    section_id integer,
    source_type text,
    source_id text,
    source_version text,
...
--
-- Name: tariff_knowledge_nodes_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.tariff_knowledge_nodes ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.tariff_knowledge_nodes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: tariff_knowledge_public_atar_rulings; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.tariff_knowledge_public_atar_rulings (
    id integer NOT NULL,
    ref text NOT NULL,
...
--
-- Name: tariff_knowledge_public_atar_rulings_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.tariff_knowledge_public_atar_rulings ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.tariff_knowledge_public_atar_rulings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: versions; Type: TABLE; Schema: uk; Owner: -
--
...
--
-- Name: versions_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--
...
--
-- Name: search_analytics_snapshots search_analytics_snapshots_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.search_analytics_snapshots
    ADD CONSTRAINT search_analytics_snapshots_pkey PRIMARY KEY (id);
...
--
-- Name: tariff_changes_job_statuses tariff_changes_job_statuses_operation_date_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tariff_changes_job_statuses
    ADD CONSTRAINT tariff_changes_job_statuses_operation_date_key UNIQUE (operation_date);


--
-- Name: tariff_changes_job_statuses tariff_changes_job_statuses_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tariff_changes_job_statuses
    ADD CONSTRAINT tariff_changes_job_statuses_pkey PRIMARY KEY (id);
...
--
-- Name: user_subscription_targets user_subscription_targets_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_subscription_targets
    ADD CONSTRAINT user_subscription_targets_pkey PRIMARY KEY (id);
...
--
-- Name: admin_configurations admin_configurations_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--
...
--
-- Name: cds_update_notifications cds_update_notifications_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--
...
--
-- Name: customs_tariff_chapter_notes customs_tariff_chapter_notes_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--
...
--
-- Name: customs_tariff_general_rules customs_tariff_general_rules_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--
...
--
-- Name: customs_tariff_section_notes customs_tariff_section_notes_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--
...
--
-- Name: customs_tariff_updates customs_tariff_updates_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--
...
--
-- Name: description_intercepts description_intercepts_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--
...
--
-- Name: evaluation_experiments evaluation_experiments_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.evaluation_experiments
    ADD CONSTRAINT evaluation_experiments_pkey PRIMARY KEY (id);


--
-- Name: evaluation_results evaluation_results_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.evaluation_results
    ADD CONSTRAINT evaluation_results_pkey PRIMARY KEY (id);


--
-- Name: evaluation_runs evaluation_runs_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.evaluation_runs
...
--
-- Name: goods_nomenclature_intercepts goods_nomenclature_intercepts_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--
...
--
-- Name: goods_nomenclature_labels goods_nomenclature_labels_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--
...
--
-- Name: tariff_changes tariff_changes_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--
...
--
-- Name: tariff_knowledge_compressed_notes tariff_knowledge_compressed_notes_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.tariff_knowledge_compressed_notes
    ADD CONSTRAINT tariff_knowledge_compressed_notes_pkey PRIMARY KEY (goods_nomenclature_sid);


--
-- Name: tariff_knowledge_edges tariff_knowledge_edges_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.tariff_knowledge_edges
    ADD CONSTRAINT tariff_knowledge_edges_pkey PRIMARY KEY (id);


--
-- Name: tariff_knowledge_nodes tariff_knowledge_nodes_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.tariff_knowledge_nodes
    ADD CONSTRAINT tariff_knowledge_nodes_pkey PRIMARY KEY (id);


--
-- Name: tariff_knowledge_public_atar_rulings tariff_knowledge_public_atar_rulings_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--
...
--
-- Name: versions versions_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--
...
--
-- Name: idx_search_analytics_snapshots_unique_window; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX idx_search_analytics_snapshots_unique_window ON uk.search_analytics_snapshots USING btree (service, period, view, generated_at);


--
-- Name: search_analytics_snapshots_data_through_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX search_analytics_snapshots_data_through_index ON uk.search_analytics_snapshots USING btree (data_through);


--
-- Name: search_analytics_snapshots_generated_at_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX search_analytics_snapshots_generated_at_index ON uk.search_analytics_snapshots USING btree (generated_at);


--
-- Name: search_analytics_snapshots_period_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX search_analytics_snapshots_period_index ON uk.search_analytics_snapshots USING btree (period);


--
-- Name: search_analytics_snapshots_service_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX search_analytics_snapshots_service_index ON uk.search_analytics_snapshots USING btree (service);


--
-- Name: search_analytics_snapshots_view_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX search_analytics_snapshots_view_index ON uk.search_analytics_snapshots USING btree (view);


--
-- Name: public_tariff_changes_job_statuses_operation_date_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX public_tariff_changes_job_statuses_operation_date_index ON public.tariff_changes_job_statuses USING btree (operation_date);


--
-- Name: user_subscriptions_target_unique_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX user_subscriptions_target_unique_idx ON public.user_subscription_targets USING btree (user_subscriptions_uuid, target_id, target_type);
...
--
-- Name: customs_tariff_chapter_notes_customs_tariff_update_version_chap; Type: INDEX; Schema: uk; Owner: -
--
...
--
-- Name: customs_tariff_general_rules_customs_tariff_update_version_rule; Type: INDEX; Schema: uk; Owner: -
--
...
--
-- Name: customs_tariff_section_notes_customs_tariff_update_version_sect; Type: INDEX; Schema: uk; Owner: -
--
...
--
-- Name: description_intercepts_excluded_index; Type: INDEX; Schema: uk; Owner: -
--
...
--
-- Name: evaluation_experiments_name_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX evaluation_experiments_name_index ON uk.evaluation_experiments USING btree (name);


--
-- Name: evaluation_results_expected_code_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX evaluation_results_expected_code_index ON uk.evaluation_results USING btree (expected_code);


--
-- Name: evaluation_results_persona_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX evaluation_results_persona_index ON uk.evaluation_results USING btree (persona);


--
-- Name: evaluation_results_run_id_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX evaluation_results_run_id_index ON uk.evaluation_results USING btree (run_id);


--
-- Name: evaluation_results_run_source_persona_uidx; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX evaluation_results_run_source_persona_uidx ON uk.evaluation_results USING btree (run_id, source_id, persona);


--
-- Name: evaluation_runs_configuration_digest_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX evaluation_runs_configuration_digest_index ON uk.evaluation_runs USING btree (configuration_digest);


--
-- Name: evaluation_runs_experiment_id_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX evaluation_runs_experiment_id_index ON uk.evaluation_runs USING btree (experiment_id);
...
CREATE INDEX evaluation_runs_question_model_index ON uk.evaluation_runs USING btree (question_model);


--
-- Name: evaluation_runs_simulator_model_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX evaluation_runs_simulator_model_index ON uk.evaluation_runs USING btree (simulator_model);


--
-- Name: evaluation_runs_status_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX evaluation_runs_status_index ON uk.evaluation_runs USING btree (status);
...
--
-- Name: goods_nomenclature_intercepts_excluded_index; Type: INDEX; Schema: uk; Owner: -
--
...
--
-- Name: goods_nomenclature_labels_goods_nomenclature_item_id_index; Type: INDEX; Schema: uk; Owner: -
--
...
--
-- Name: goods_nomenclature_labels_labels_index; Type: INDEX; Schema: uk; Owner: -
--
...
--
-- Name: idx_ac_area; Type: INDEX; Schema: uk; Owner: -
--
...
--
-- Name: idx_ac_name; Type: INDEX; Schema: uk; Owner: -
--
...
--
-- Name: idx_description_intercepts_sources_gin; Type: INDEX; Schema: uk; Owner: -
--
...
--
-- Name: idx_self_texts_search_embedding_stale; Type: INDEX; Schema: uk; Owner: -
--
...
--
-- Name: tariff_knowledge_compressed_notes_approved_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_compressed_notes_approved_index ON uk.tariff_knowledge_compressed_notes USING btree (approved) WHERE (approved = true);


--
-- Name: tariff_knowledge_compressed_notes_expired_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_compressed_notes_expired_index ON uk.tariff_knowledge_compressed_notes USING btree (expired) WHERE (expired = true);


--
-- Name: tariff_knowledge_compressed_notes_goods_nomenclature_item_id_in; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_compressed_notes_goods_nomenclature_item_id_in ON uk.tariff_knowledge_compressed_notes USING btree (goods_nomenclature_item_id);


--
-- Name: tariff_knowledge_compressed_notes_needs_review_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_compressed_notes_needs_review_index ON uk.tariff_knowledge_compressed_notes USING btree (needs_review) WHERE (needs_review = true);


--
-- Name: tariff_knowledge_edges_metadata_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_edges_metadata_index ON uk.tariff_knowledge_edges USING gin (metadata);


--
-- Name: tariff_knowledge_edges_relationship_type_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_edges_relationship_type_index ON uk.tariff_knowledge_edges USING btree (relationship_type);


--
-- Name: tariff_knowledge_edges_source_node_id_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_edges_source_node_id_index ON uk.tariff_knowledge_edges USING btree (source_node_id);


--
-- Name: tariff_knowledge_edges_target_node_id_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_edges_target_node_id_index ON uk.tariff_knowledge_edges USING btree (target_node_id);


--
-- Name: tariff_knowledge_edges_target_node_id_relationship_type_index; Type: INDEX; Schema: uk; Owner: -
--
...
CREATE INDEX tariff_knowledge_nodes_goods_nomenclature_item_id_index ON uk.tariff_knowledge_nodes USING btree (goods_nomenclature_item_id);


--
-- Name: tariff_knowledge_nodes_goods_nomenclature_sid_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_nodes_goods_nomenclature_sid_index ON uk.tariff_knowledge_nodes USING btree (goods_nomenclature_sid);


--
-- Name: tariff_knowledge_nodes_key_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX tariff_knowledge_nodes_key_index ON uk.tariff_knowledge_nodes USING btree (key);


--
-- Name: tariff_knowledge_nodes_metadata_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_nodes_metadata_index ON uk.tariff_knowledge_nodes USING gin (metadata);


--
-- Name: tariff_knowledge_nodes_node_type_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_nodes_node_type_index ON uk.tariff_knowledge_nodes USING btree (node_type);


--
-- Name: tariff_knowledge_nodes_section_id_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_nodes_section_id_index ON uk.tariff_knowledge_nodes USING btree (section_id);


--
-- Name: tariff_knowledge_nodes_source_type_source_id_source_version_ind; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_nodes_source_type_source_id_source_version_ind ON uk.tariff_knowledge_nodes USING btree (source_type, source_id, source_version);


--
-- Name: tariff_knowledge_public_atar_rulings_commodity_code_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_public_atar_rulings_commodity_code_index ON uk.tariff_knowledge_public_atar_rulings USING btree (commodity_code);


--
-- Name: tariff_knowledge_public_atar_rulings_goods_nomenclature_item_id_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_public_atar_rulings_goods_nomenclature_item_id_index ON uk.tariff_knowledge_public_atar_rulings USING btree (goods_nomenclature_item_id);


--
-- Name: tariff_knowledge_public_atar_rulings_validity_end_date_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_public_atar_rulings_validity_end_date_index ON uk.tariff_knowledge_public_atar_rulings USING btree (validity_end_date);


--
-- Name: tariff_knowledge_public_atar_rulings_keywords_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_public_atar_rulings_keywords_index ON uk.tariff_knowledge_public_atar_rulings USING gin (keywords);
...
CREATE INDEX tariff_knowledge_public_atar_rulings_raw_fields_index ON uk.tariff_knowledge_public_atar_rulings USING gin (raw_fields);


--
-- Name: tariff_knowledge_public_atar_rulings_ref_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX tariff_knowledge_public_atar_rulings_ref_index ON uk.tariff_knowledge_public_atar_rulings USING btree (ref);


--
-- Name: tariff_knowledge_public_atar_rulings_validity_start_date_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX tariff_knowledge_public_atar_rulings_validity_start_date_index ON uk.tariff_knowledge_public_atar_rulings USING btree (validity_start_date);
...
--
-- Name: versions_created_at_index; Type: INDEX; Schema: uk; Owner: -
--
...
--
-- Name: versions_item_type_item_id_index; Type: INDEX; Schema: uk; Owner: -
--
...
--
-- Name: user_subscription_targets user_subscription_targets_user_subscriptions_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_subscription_targets
    ADD CONSTRAINT user_subscription_targets_user_subscriptions_uuid_fkey FOREIGN KEY (user_subscriptions_uuid) REFERENCES public.user_subscriptions(uuid);
...
--
-- Name: evaluation_results evaluation_results_run_id_fkey; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.evaluation_results
    ADD CONSTRAINT evaluation_results_run_id_fkey FOREIGN KEY (run_id) REFERENCES uk.evaluation_runs(id) ON DELETE CASCADE;


--
-- Name: evaluation_runs evaluation_runs_experiment_id_fkey; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.evaluation_runs
    ADD CONSTRAINT evaluation_runs_experiment_id_fkey FOREIGN KEY (experiment_id) REFERENCES uk.evaluation_experiments(id) ON DELETE RESTRICT;
...
--
-- Name: tariff_knowledge_edges tariff_knowledge_edges_source_node_id_fkey; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.tariff_knowledge_edges
    ADD CONSTRAINT tariff_knowledge_edges_source_node_id_fkey FOREIGN KEY (source_node_id) REFERENCES uk.tariff_knowledge_nodes(id) ON DELETE CASCADE;


--
-- Name: tariff_knowledge_edges tariff_knowledge_edges_target_node_id_fkey; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.tariff_knowledge_edges
    ADD CONSTRAINT tariff_knowledge_edges_target_node_id_fkey FOREIGN KEY (target_node_id) REFERENCES uk.tariff_knowledge_nodes(id) ON DELETE CASCADE;


--
-- Name: reject_vat_guidance_mutation(); Type: FUNCTION; Schema: uk; Owner: -
--

CREATE FUNCTION uk.reject_vat_guidance_mutation() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: vat_commodity_measures; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.vat_commodity_measures (
    id integer NOT NULL,
    ...
    created_at timestamp without time zone NOT NULL,
    CONSTRAINT vat_commodity_measures_code_format CHECK (((goods_nomenclature_item_id)::text ~ '^[0-9]{10}$'::text)),
    CONSTRAINT vat_commodity_measures_content_sha256_format CHECK (((content_sha256)::text ~ '^[0-9a-f]{64}$'::text)),
    CONSTRAINT vat_commodity_measures_suffix_format CHECK (((producline_suffix)::text ~ '^[0-9]{2}$'::text)),
    CONSTRAINT vat_commodity_measures_validity_dates CHECK (((validity_end_date IS NULL) OR (validity_end_date >= validity_start_date)))
);


--
-- Name: vat_commodity_measures_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.vat_commodity_measures ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.vat_commodity_measures_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: vat_commodity_questionnaire_question_sets; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.vat_commodity_questionnaire_question_sets (
    release_id integer NOT NULL,
    questionnaire_id integer CONSTRAINT vat_commodity_questionnaire_question__questionnaire_id_not_null NOT NULL,
    question_set_id integer CONSTRAINT vat_commodity_questionnaire_question_s_question_set_id_not_null NOT NULL,
    "position" integer NOT NULL,
    created_at timestamp without time zone NOT NULL,
    CONSTRAINT vat_questionnaire_sets_positive_position CHECK (("position" > 0))
);


--
-- Name: vat_commodity_questionnaires; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.vat_commodity_questionnaires (
    id integer NOT NULL,
    release_id integer NOT NULL,
    goods_nomenclature_sid integer NOT NULL,
    goods_nomenclature_item_id character varying(10) CONSTRAINT vat_commodity_questionnaire_goods_nomenclature_item_id_not_null NOT NULL,
    producline_suffix character varying(2) NOT NULL,
    result_kind text NOT NULL,
    expected_vat_options jsonb NOT NULL,
    membership_order_sha256 character varying(64) NOT NULL,
    assembled_questions_sha256 character varying(64) CONSTRAINT vat_commodity_questionnaire_assembled_questions_sha256_not_null NOT NULL,
    created_at timestamp without time zone NOT NULL,
    CONSTRAINT vat_commodity_questionnaires_code_format CHECK (((goods_nomenclature_item_id)::text ~ '^[0-9]{10}$'::text)),
    CONSTRAINT vat_commodity_questionnaires_hash_formats CHECK ((((membership_order_sha256)::text ~ '^[0-9a-f]{64}$'::text) AND ((assembled_questions_sha256)::text ~ '^[0-9a-f]{64}$'::text))),
    CONSTRAINT vat_commodity_questionnaires_options_array CHECK ((jsonb_typeof(expected_vat_options) = 'array'::text)),
    CONSTRAINT vat_commodity_questionnaires_result_kind CHECK ((result_kind = ANY (ARRAY['questions'::text, 'checked_empty'::text]))),
    CONSTRAINT vat_commodity_questionnaires_suffix_format CHECK (((producline_suffix)::text ~ '^[0-9]{2}$'::text))
);


--
-- Name: vat_commodity_questionnaires_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.vat_commodity_questionnaires ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.vat_commodity_questionnaires_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: vat_guide_versions; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.vat_guide_versions (
    id integer NOT NULL,
    guide_id integer NOT NULL,
    title text NOT NULL,
    ...
    created_at timestamp without time zone NOT NULL,
    CONSTRAINT vat_guide_versions_body_sha256_format CHECK (((body_sha256)::text ~ '^[0-9a-f]{64}$'::text)),
    CONSTRAINT vat_guide_versions_capture_metadata_object CHECK ((jsonb_typeof(capture_metadata) = 'object'::text)),
    CONSTRAINT vat_guide_versions_sections_array CHECK ((jsonb_typeof(sections) = 'array'::text))
);


--
-- Name: vat_guide_versions_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.vat_guide_versions ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.vat_guide_versions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: vat_guides; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.vat_guides (
    id integer NOT NULL,
...
--
-- Name: vat_guides_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.vat_guides ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.vat_guides_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: vat_question_set_commodity_measures; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.vat_question_set_commodity_measures (
    id integer NOT NULL,
    release_id integer NOT NULL,
    question_set_id integer NOT NULL,
    commodity_measure_id integer CONSTRAINT vat_question_set_commodity_measur_commodity_measure_id_not_null NOT NULL,
    outcome_key text NOT NULL,
    decision_sha256 character varying(64) NOT NULL,
    evidence_references jsonb DEFAULT '[]'::jsonb CONSTRAINT vat_question_set_commodity_measure_evidence_references_not_null NOT NULL,
    created_at timestamp without time zone NOT NULL,
    CONSTRAINT vat_qs_commodity_measures_decision_sha256_format CHECK (((decision_sha256)::text ~ '^[0-9a-f]{64}$'::text)),
    CONSTRAINT vat_qs_commodity_measures_evidence_array CHECK ((jsonb_typeof(evidence_references) = 'array'::text))
);


--
-- Name: vat_question_set_commodity_measures_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.vat_question_set_commodity_measures ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.vat_question_set_commodity_measures_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: vat_question_sets; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.vat_question_sets (
    id integer NOT NULL,
    question_set_key text NOT NULL,
    title text NOT NULL,
    root_question_key text NOT NULL,
    graph jsonb NOT NULL,
    content_sha256 character varying(64) NOT NULL,
    generation_metadata jsonb DEFAULT '{}'::jsonb NOT NULL,
    machine_verification_metadata jsonb DEFAULT '{}'::jsonb NOT NULL,
    created_at timestamp without time zone NOT NULL,
    CONSTRAINT vat_question_sets_content_sha256_format CHECK (((content_sha256)::text ~ '^[0-9a-f]{64}$'::text)),
    CONSTRAINT vat_question_sets_generation_metadata_object CHECK ((jsonb_typeof(generation_metadata) = 'object'::text)),
    CONSTRAINT vat_question_sets_graph_object CHECK ((jsonb_typeof(graph) = 'object'::text)),
    CONSTRAINT vat_question_sets_verification_metadata_object CHECK ((jsonb_typeof(machine_verification_metadata) = 'object'::text))
);


--
-- Name: vat_question_sets_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.vat_question_sets ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.vat_question_sets_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: vat_release_events; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.vat_release_events (
    id integer NOT NULL,
    release_id integer,
    event_type text NOT NULL,
    created_at timestamp without time zone NOT NULL,
    CONSTRAINT vat_release_events_type_and_release CHECK ((((event_type = 'activate'::text) AND (release_id IS NOT NULL)) OR ((event_type = 'disable'::text) AND (release_id IS NULL))))
);


--
-- Name: vat_release_events_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.vat_release_events ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.vat_release_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: vat_release_guides; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.vat_release_guides (
    release_id integer NOT NULL,
    guide_id integer NOT NULL,
    guide_version_id integer NOT NULL,
    analysis_sha256 character varying(64) NOT NULL,
    result text NOT NULL,
    created_at timestamp without time zone NOT NULL,
    CONSTRAINT vat_release_guides_analysis_sha256_format CHECK (((analysis_sha256)::text ~ '^[0-9a-f]{64}$'::text)),
    CONSTRAINT vat_release_guides_result CHECK ((result = ANY (ARRAY['questions'::text, 'no_questions'::text])))
);


--
-- Name: vat_release_question_sets; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.vat_release_question_sets (
    release_id integer NOT NULL,
    question_set_key text NOT NULL,
    question_set_id integer NOT NULL,
    verification_sha256 character varying(64) NOT NULL,
    created_at timestamp without time zone NOT NULL,
    CONSTRAINT vat_release_question_sets_verification_sha256_format CHECK (((verification_sha256)::text ~ '^[0-9a-f]{64}$'::text))
);


--
-- Name: vat_releases; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.vat_releases (
    id integer NOT NULL,
    release_key text NOT NULL,
    schema_version integer NOT NULL,
    tariff_snapshot_as_of date NOT NULL,
    supported_start_date date NOT NULL,
    supported_end_date date,
    source_snapshot_sha256 character varying(64) NOT NULL,
    tariff_snapshot_sha256 character varying(64) NOT NULL,
    content_sha256 character varying(64) NOT NULL,
    guide_count integer NOT NULL,
    no_question_guide_count integer NOT NULL,
    question_set_count integer NOT NULL,
    covered_commodity_count integer NOT NULL,
    questions_questionnaire_count integer NOT NULL,
    checked_empty_questionnaire_count integer NOT NULL,
    commodity_measure_count integer NOT NULL,
    link_count integer NOT NULL,
    covered_commodity_list_sha256 character varying(64) NOT NULL,
    activation_manifest jsonb NOT NULL,
    signature_algorithm text NOT NULL,
    signed_payload_sha256 character varying(64) NOT NULL,
    signature text NOT NULL,
    generated_at timestamp without time zone NOT NULL,
    created_at timestamp without time zone NOT NULL,
    CONSTRAINT vat_releases_activation_manifest_object CHECK ((jsonb_typeof(activation_manifest) = 'object'::text)),
    CONSTRAINT vat_releases_counts_non_negative CHECK (((guide_count >= 0) AND (no_question_guide_count >= 0) AND (question_set_count >= 0) AND (covered_commodity_count >= 0) AND (questions_questionnaire_count >= 0) AND (checked_empty_questionnaire_count >= 0) AND (commodity_measure_count >= 0) AND (link_count >= 0))),
    CONSTRAINT vat_releases_hash_formats CHECK ((((source_snapshot_sha256)::text ~ '^[0-9a-f]{64}$'::text) AND ((tariff_snapshot_sha256)::text ~ '^[0-9a-f]{64}$'::text) AND ((content_sha256)::text ~ '^[0-9a-f]{64}$'::text) AND ((covered_commodity_list_sha256)::text ~ '^[0-9a-f]{64}$'::text) AND ((signed_payload_sha256)::text ~ '^[0-9a-f]{64}$'::text))),
    CONSTRAINT vat_releases_supported_dates CHECK (((supported_end_date IS NULL) OR (supported_end_date >= supported_start_date)))
);


--
-- Name: vat_releases_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.vat_releases ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.vat_releases_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: vat_commodity_measures vat_commodity_measures_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_commodity_measures
    ADD CONSTRAINT vat_commodity_measures_pkey PRIMARY KEY (id);


--
-- Name: vat_commodity_questionnaire_question_sets vat_commodity_questionnaire_question_sets_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_commodity_questionnaire_question_sets
    ADD CONSTRAINT vat_commodity_questionnaire_question_sets_pkey PRIMARY KEY (release_id, questionnaire_id, question_set_id);


--
-- Name: vat_commodity_questionnaires vat_commodity_questionnaires_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_commodity_questionnaires
    ADD CONSTRAINT vat_commodity_questionnaires_pkey PRIMARY KEY (id);


--
-- Name: vat_guide_versions vat_guide_versions_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_guide_versions
    ADD CONSTRAINT vat_guide_versions_pkey PRIMARY KEY (id);


--
-- Name: vat_guides vat_guides_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_guides
    ADD CONSTRAINT vat_guides_pkey PRIMARY KEY (id);


--
-- Name: vat_question_set_commodity_measures vat_question_set_commodity_measures_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_question_set_commodity_measures
    ADD CONSTRAINT vat_question_set_commodity_measures_pkey PRIMARY KEY (id);


--
-- Name: vat_question_sets vat_question_sets_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_question_sets
    ADD CONSTRAINT vat_question_sets_pkey PRIMARY KEY (id);


--
-- Name: vat_release_events vat_release_events_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_release_events
    ADD CONSTRAINT vat_release_events_pkey PRIMARY KEY (id);


--
-- Name: vat_release_guides vat_release_guides_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_release_guides
    ADD CONSTRAINT vat_release_guides_pkey PRIMARY KEY (release_id, guide_id);


--
-- Name: vat_release_question_sets vat_release_question_sets_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_release_question_sets
    ADD CONSTRAINT vat_release_question_sets_pkey PRIMARY KEY (release_id, question_set_key);


--
-- Name: vat_releases vat_releases_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_releases
    ADD CONSTRAINT vat_releases_pkey PRIMARY KEY (id);


--
-- Name: vat_commodity_measures_code_idx; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX vat_commodity_measures_code_idx ON uk.vat_commodity_measures USING btree (release_id, goods_nomenclature_item_id, producline_suffix);


--
-- Name: vat_commodity_measures_identity_uidx; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX vat_commodity_measures_identity_uidx ON uk.vat_commodity_measures USING btree (release_id, measure_sid, goods_nomenclature_sid, goods_nomenclature_item_id, producline_suffix);


--
-- Name: vat_commodity_measures_release_id_goods_nomenclature_sid_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX vat_commodity_measures_release_id_goods_nomenclature_sid_index ON uk.vat_commodity_measures USING btree (release_id, goods_nomenclature_sid);


--
-- Name: vat_commodity_measures_release_id_id_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX vat_commodity_measures_release_id_id_index ON uk.vat_commodity_measures USING btree (release_id, id);


--
-- Name: vat_commodity_questionnaires_code_idx; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX vat_commodity_questionnaires_code_idx ON uk.vat_commodity_questionnaires USING btree (release_id, goods_nomenclature_item_id, producline_suffix);


--
-- Name: vat_commodity_questionnaires_identity_uidx; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX vat_commodity_questionnaires_identity_uidx ON uk.vat_commodity_questionnaires USING btree (release_id, goods_nomenclature_sid, goods_nomenclature_item_id, producline_suffix);


--
-- Name: vat_commodity_questionnaires_release_id_id_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX vat_commodity_questionnaires_release_id_id_index ON uk.vat_commodity_questionnaires USING btree (release_id, id);


--
-- Name: vat_guide_versions_body_sha256_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX vat_guide_versions_body_sha256_index ON uk.vat_guide_versions USING btree (body_sha256);


--
-- Name: vat_guide_versions_guide_id_body_sha256_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX vat_guide_versions_guide_id_body_sha256_index ON uk.vat_guide_versions USING btree (guide_id, body_sha256);


--
-- Name: vat_guide_versions_id_guide_id_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX vat_guide_versions_id_guide_id_index ON uk.vat_guide_versions USING btree (id, guide_id);


--
-- Name: vat_guides_content_id_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX vat_guides_content_id_index ON uk.vat_guides USING btree (content_id);


--
-- Name: vat_guides_guide_key_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX vat_guides_guide_key_index ON uk.vat_guides USING btree (guide_key);


--
-- Name: vat_qs_commodity_measures_identity_uidx; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX vat_qs_commodity_measures_identity_uidx ON uk.vat_question_set_commodity_measures USING btree (release_id, question_set_id, commodity_measure_id);


--
-- Name: vat_question_sets_content_sha256_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX vat_question_sets_content_sha256_index ON uk.vat_question_sets USING btree (content_sha256);


--
-- Name: vat_question_sets_id_question_set_key_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX vat_question_sets_id_question_set_key_index ON uk.vat_question_sets USING btree (id, question_set_key);


--
-- Name: vat_question_sets_key_content_uidx; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX vat_question_sets_key_content_uidx ON uk.vat_question_sets USING btree (question_set_key, content_sha256);


--
-- Name: vat_questionnaire_sets_position_uidx; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX vat_questionnaire_sets_position_uidx ON uk.vat_commodity_questionnaire_question_sets USING btree (release_id, questionnaire_id, "position");


--
-- Name: vat_release_events_created_at_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX vat_release_events_created_at_index ON uk.vat_release_events USING btree (created_at);


--
-- Name: vat_release_events_release_id_created_at_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX vat_release_events_release_id_created_at_index ON uk.vat_release_events USING btree (release_id, created_at);


--
-- Name: vat_release_guides_release_id_guide_version_id_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX vat_release_guides_release_id_guide_version_id_index ON uk.vat_release_guides USING btree (release_id, guide_version_id);


--
-- Name: vat_release_question_sets_release_id_question_set_id_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX vat_release_question_sets_release_id_question_set_id_index ON uk.vat_release_question_sets USING btree (release_id, question_set_id);


--
-- Name: vat_releases_content_sha256_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX vat_releases_content_sha256_index ON uk.vat_releases USING btree (content_sha256);


--
-- Name: vat_releases_release_key_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX vat_releases_release_key_index ON uk.vat_releases USING btree (release_key);


--
-- Name: vat_releases_supported_start_date_supported_end_date_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX vat_releases_supported_start_date_supported_end_date_index ON uk.vat_releases USING btree (supported_start_date, supported_end_date);


--
-- Name: vat_commodity_measures vat_commodity_measures_immutable; Type: TRIGGER; Schema: uk; Owner: -
--

CREATE TRIGGER vat_commodity_measures_immutable BEFORE DELETE OR UPDATE ON uk.vat_commodity_measures FOR EACH ROW EXECUTE FUNCTION uk.reject_vat_guidance_mutation();


--
-- Name: vat_commodity_questionnaire_question_sets vat_commodity_questionnaire_question_sets_immutable; Type: TRIGGER; Schema: uk; Owner: -
--

CREATE TRIGGER vat_commodity_questionnaire_question_sets_immutable BEFORE DELETE OR UPDATE ON uk.vat_commodity_questionnaire_question_sets FOR EACH ROW EXECUTE FUNCTION uk.reject_vat_guidance_mutation();


--
-- Name: vat_commodity_questionnaires vat_commodity_questionnaires_immutable; Type: TRIGGER; Schema: uk; Owner: -
--

CREATE TRIGGER vat_commodity_questionnaires_immutable BEFORE DELETE OR UPDATE ON uk.vat_commodity_questionnaires FOR EACH ROW EXECUTE FUNCTION uk.reject_vat_guidance_mutation();


--
-- Name: vat_guide_versions vat_guide_versions_immutable; Type: TRIGGER; Schema: uk; Owner: -
--

CREATE TRIGGER vat_guide_versions_immutable BEFORE DELETE OR UPDATE ON uk.vat_guide_versions FOR EACH ROW EXECUTE FUNCTION uk.reject_vat_guidance_mutation();


--
-- Name: vat_guides vat_guides_immutable; Type: TRIGGER; Schema: uk; Owner: -
--

CREATE TRIGGER vat_guides_immutable BEFORE DELETE OR UPDATE ON uk.vat_guides FOR EACH ROW EXECUTE FUNCTION uk.reject_vat_guidance_mutation();


--
-- Name: vat_question_set_commodity_measures vat_question_set_commodity_measures_immutable; Type: TRIGGER; Schema: uk; Owner: -
--

CREATE TRIGGER vat_question_set_commodity_measures_immutable BEFORE DELETE OR UPDATE ON uk.vat_question_set_commodity_measures FOR EACH ROW EXECUTE FUNCTION uk.reject_vat_guidance_mutation();


--
-- Name: vat_question_sets vat_question_sets_immutable; Type: TRIGGER; Schema: uk; Owner: -
--

CREATE TRIGGER vat_question_sets_immutable BEFORE DELETE OR UPDATE ON uk.vat_question_sets FOR EACH ROW EXECUTE FUNCTION uk.reject_vat_guidance_mutation();


--
-- Name: vat_release_events vat_release_events_immutable; Type: TRIGGER; Schema: uk; Owner: -
--

CREATE TRIGGER vat_release_events_immutable BEFORE DELETE OR UPDATE ON uk.vat_release_events FOR EACH ROW EXECUTE FUNCTION uk.reject_vat_guidance_mutation();


--
-- Name: vat_release_guides vat_release_guides_immutable; Type: TRIGGER; Schema: uk; Owner: -
--

CREATE TRIGGER vat_release_guides_immutable BEFORE DELETE OR UPDATE ON uk.vat_release_guides FOR EACH ROW EXECUTE FUNCTION uk.reject_vat_guidance_mutation();


--
-- Name: vat_release_question_sets vat_release_question_sets_immutable; Type: TRIGGER; Schema: uk; Owner: -
--

CREATE TRIGGER vat_release_question_sets_immutable BEFORE DELETE OR UPDATE ON uk.vat_release_question_sets FOR EACH ROW EXECUTE FUNCTION uk.reject_vat_guidance_mutation();


--
-- Name: vat_releases vat_releases_immutable; Type: TRIGGER; Schema: uk; Owner: -
--

CREATE TRIGGER vat_releases_immutable BEFORE DELETE OR UPDATE ON uk.vat_releases FOR EACH ROW EXECUTE FUNCTION uk.reject_vat_guidance_mutation();


--
-- Name: vat_commodity_measures vat_commodity_measures_release_id_fkey; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_commodity_measures
    ADD CONSTRAINT vat_commodity_measures_release_id_fkey FOREIGN KEY (release_id) REFERENCES uk.vat_releases(id) ON DELETE RESTRICT;


--
-- Name: vat_commodity_questionnaires vat_commodity_questionnaires_release_id_fkey; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_commodity_questionnaires
    ADD CONSTRAINT vat_commodity_questionnaires_release_id_fkey FOREIGN KEY (release_id) REFERENCES uk.vat_releases(id) ON DELETE RESTRICT;


--
-- Name: vat_guide_versions vat_guide_versions_guide_id_fkey; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_guide_versions
    ADD CONSTRAINT vat_guide_versions_guide_id_fkey FOREIGN KEY (guide_id) REFERENCES uk.vat_guides(id) ON DELETE RESTRICT;


--
-- Name: vat_question_set_commodity_measures vat_qs_commodity_measures_release_measure_fk; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_question_set_commodity_measures
    ADD CONSTRAINT vat_qs_commodity_measures_release_measure_fk FOREIGN KEY (release_id, commodity_measure_id) REFERENCES uk.vat_commodity_measures(release_id, id);


--
-- Name: vat_question_set_commodity_measures vat_qs_commodity_measures_release_qs_fk; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_question_set_commodity_measures
    ADD CONSTRAINT vat_qs_commodity_measures_release_qs_fk FOREIGN KEY (release_id, question_set_id) REFERENCES uk.vat_release_question_sets(release_id, question_set_id);


--
-- Name: vat_commodity_questionnaire_question_sets vat_questionnaire_sets_release_question_set_fk; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_commodity_questionnaire_question_sets
    ADD CONSTRAINT vat_questionnaire_sets_release_question_set_fk FOREIGN KEY (release_id, question_set_id) REFERENCES uk.vat_release_question_sets(release_id, question_set_id);


--
-- Name: vat_commodity_questionnaire_question_sets vat_questionnaire_sets_release_questionnaire_fk; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_commodity_questionnaire_question_sets
    ADD CONSTRAINT vat_questionnaire_sets_release_questionnaire_fk FOREIGN KEY (release_id, questionnaire_id) REFERENCES uk.vat_commodity_questionnaires(release_id, id);


--
-- Name: vat_release_events vat_release_events_release_id_fkey; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_release_events
    ADD CONSTRAINT vat_release_events_release_id_fkey FOREIGN KEY (release_id) REFERENCES uk.vat_releases(id) ON DELETE RESTRICT;


--
-- Name: vat_release_guides vat_release_guides_release_id_fkey; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_release_guides
    ADD CONSTRAINT vat_release_guides_release_id_fkey FOREIGN KEY (release_id) REFERENCES uk.vat_releases(id) ON DELETE RESTRICT;


--
-- Name: vat_release_guides vat_release_guides_version_guide_fk; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_release_guides
    ADD CONSTRAINT vat_release_guides_version_guide_fk FOREIGN KEY (guide_version_id, guide_id) REFERENCES uk.vat_guide_versions(id, guide_id);


--
-- Name: vat_release_question_sets vat_release_question_sets_release_id_fkey; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_release_question_sets
    ADD CONSTRAINT vat_release_question_sets_release_id_fkey FOREIGN KEY (release_id) REFERENCES uk.vat_releases(id) ON DELETE RESTRICT;


--
-- Name: vat_release_question_sets vat_release_question_sets_version_key_fk; Type: FK CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.vat_release_question_sets
    ADD CONSTRAINT vat_release_question_sets_version_key_fk FOREIGN KEY (question_set_id, question_set_key) REFERENCES uk.vat_question_sets(id, question_set_key);
...
\unrestrict bjxEVbqyia1AzAjvfdhgHgOU28YH4fA0DTTYBJRPjyA6kMc6eqFe8IUyieSF1zc
...
INSERT INTO "schema_migrations" ("filename") VALUES ('20250829140321_adds_update_sent_to_base_update.rb');
INSERT INTO "schema_migrations" ("filename") VALUES ('20250902151220_create_user_delta_preferences.rb');
...
INSERT INTO "schema_migrations" ("filename") VALUES ('20260727120000_create_vat_guidance_storage.rb');
