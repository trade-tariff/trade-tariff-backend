...
--
-- Name: goods_nomenclature_description_periods; Type: MATERIALIZED VIEW; Schema: uk; Owner: -
--

CREATE MATERIALIZED VIEW uk.goods_nomenclature_description_periods AS
...
--
-- Name: goods_nomenclature_descriptions; Type: MATERIALIZED VIEW; Schema: uk; Owner: -
--

CREATE MATERIALIZED VIEW uk.goods_nomenclature_descriptions AS
...
CREATE MATERIALIZED VIEW uk.goods_nomenclature_tree_nodes AS
 WITH tree_nodes AS (
         ...
         SELECT DISTINCT ON (t_1.goods_nomenclature_indent_sid) t_1.goods_nomenclature_indent_sid,
 ...
 SELECT t.goods_nomenclature_indent_sid,
    t.goods_nomenclature_sid,
    t.number_indents,
    t.goods_nomenclature_item_id,
    t.productline_suffix,
    t."position",
...
--
-- Name: goods_nomenclature_description_periods_goods_nomenclature_descr; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX goods_nomenclature_description_periods_goods_nomenclature_descr ON uk.goods_nomenclature_description_periods USING btree (goods_nomenclature_description_period_sid, goods_nomenclature_sid);


--
-- Name: goods_nomenclature_description_periods_goods_nomenclature_sid_v; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX goods_nomenclature_description_periods_goods_nomenclature_sid_v ON uk.goods_nomenclature_description_periods USING btree (goods_nomenclature_sid, validity_start_date);


--
-- Name: goods_nomenclature_description_periods_oid_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX goods_nomenclature_description_periods_oid_index ON uk.goods_nomenclature_description_periods USING btree (oid);


--
-- Name: goods_nomenclature_descriptions_goods_nomenclature_description_; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX goods_nomenclature_descriptions_goods_nomenclature_description_ ON uk.goods_nomenclature_descriptions USING btree (goods_nomenclature_description_period_sid, goods_nomenclature_sid);


--
-- Name: goods_nomenclature_descriptions_goods_nomenclature_sid_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX goods_nomenclature_descriptions_goods_nomenclature_sid_index ON uk.goods_nomenclature_descriptions USING btree (goods_nomenclature_sid);


--
-- Name: goods_nomenclature_descriptions_oid_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX goods_nomenclature_descriptions_oid_index ON uk.goods_nomenclature_descriptions USING btree (oid);
...
--
-- Name: goods_nomenclature_tree_nodes_next_sibling_validity_start_date_; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX goods_nomenclature_tree_nodes_next_sibling_validity_start_date_ ON uk.goods_nomenclature_tree_nodes USING btree (next_sibling_validity_start_date);
