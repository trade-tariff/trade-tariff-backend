...
--
-- Name: search_analytics_mv_latest_state(bigint, bigint); Type: FUNCTION; Schema: uk; Owner: -
--

CREATE FUNCTION uk.search_analytics_mv_latest_state(a bigint, b bigint) RETURNS bigint
...
--
-- Name: search_analytics_mv_latest_state(bigint); Type: AGGREGATE; Schema: uk; Owner: -
--

CREATE AGGREGATE uk.search_analytics_mv_latest_state(bigint) (
    SFUNC = uk.search_analytics_mv_latest_state,
    STYPE = bigint,
    COMBINEFUNC = uk.search_analytics_mv_latest_state,
    PARALLEL = safe
);
...
--
-- Name: search_analytics_query_results; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.search_analytics_query_results (
    id integer NOT NULL,
...
--
-- Name: search_analytics_query_results_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.search_analytics_query_results ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.search_analytics_query_results_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: search_analytics_journey_observation_rows; Type: VIEW; Schema: uk; Owner: -
--

CREATE VIEW uk.search_analytics_journey_observation_rows AS
 WITH groups AS MATERIALIZED (
         SELECT r.service,
            r.reporting_date,
            (j."row" -> 'journey_keys'::text) AS keys,
                CASE
                    WHEN ((r.name = 'search_journeys'::text) AND ((j."row" ->> 'request_source'::text) = 'frontend'::text)) THEN ((1)::bigint << (EXTRACT(hour FROM (((j."row" ->> '@timestamp'::text))::timestamp with time zone AT TIME ZONE 'UTC'::text)))::integer)
                    ELSE (0)::bigint
                END AS hours,
            (j."row" ->> 'search_type'::text) AS search_type,
                CASE
                    WHEN ((r.name = 'journey_outcomes'::text) AND ((j."row" ->> 'terminal_state'::text) <> 'none'::text)) THEN ((((EXTRACT(epoch FROM ((j."row" ->> 'window_end'::text))::timestamp with time zone) * (1000000)::numeric))::bigint << 2) | (
                    CASE (j."row" ->> 'terminal_state'::text)
                        WHEN 'completed'::text THEN 1
                        WHEN 'failed'::text THEN 2
                        ELSE 3
                    END)::bigint)
                    ELSE NULL::bigint
                END AS terminal,
                CASE
                    WHEN (r.name = 'journey_outcomes'::text) THEN (((
                    CASE
                        WHEN (((j."row" ->> 'selected'::text))::integer > 0) THEN 1
                        ELSE 0
                    END |
                    CASE
                        WHEN (((j."row" ->> 'zero_result'::text))::integer > 0) THEN 2
                        ELSE 0
                    END) |
                    CASE
                        WHEN (((j."row" ->> 'questions_seen'::text))::integer > 0) THEN 4
                        ELSE 0
                    END) |
                    CASE
                        WHEN (((j."row" ->> 'unknown_seen'::text))::integer > 0) THEN 8
                        ELSE 0
                    END)
                    ELSE 0
                END AS flags
          ...
          WHERE (r.name = ANY (ARRAY['search_journeys'::text, 'journey_outcomes'::text]))
        ), observations AS MATERIALIZED (
         SELECT groups.service,
            groups.reporting_date,
            decode(
                CASE
                    WHEN (k.key ~ '^[0-9a-f]{64}$'::text) THEN k.key
                    ELSE 'invalid journey key'::text
                END, 'hex'::text) AS journey_key,
            groups.hours AS all_hours,
                CASE
                    WHEN (groups.search_type = 'classic'::text) THEN groups.hours
                    ELSE (0)::bigint
                END AS classic_hours,
                CASE
                    WHEN (groups.search_type = ANY (ARRAY['internal'::text, 'interactive'::text])) THEN groups.hours
                    ELSE (0)::bigint
                END AS internal_hours,
            groups.terminal,
            groups.flags
           FROM (groups
             CROSS JOIN LATERAL jsonb_array_elements_text(groups.keys) k(key))
        )
 SELECT service,
    reporting_date,
    journey_key,
...
--
-- Name: search_analytics_daily_journeys; Type: MATERIALIZED VIEW; Schema: uk; Owner: -
--

CREATE MATERIALIZED VIEW uk.search_analytics_daily_journeys AS
 SELECT service,
    reporting_date,
    journey_key,
    ...
    uk.search_analytics_mv_latest_state(terminal) AS terminal,
    bit_or(flags) AS flags
   FROM uk.search_analytics_journey_observation_rows
  GROUP BY service, reporting_date, journey_key
  WITH NO DATA;


--
-- Name: search_analytics_repeated_journey_keys; Type: VIEW; Schema: uk; Owner: -
--

CREATE VIEW uk.search_analytics_repeated_journey_keys AS
 SELECT service,
    journey_key
   FROM uk.search_analytics_daily_journeys
  GROUP BY service, journey_key
 HAVING (count(*) > 1);


--
-- Name: search_analytics_journey_rollup_rows; Type: VIEW; Schema: uk; Owner: -
--

CREATE VIEW uk.search_analytics_journey_rollup_rows AS
 WITH single_day AS (
         SELECT d.service,
            d.reporting_date,
            d.journey_key,
            ...
            d.flags,
                CASE
                    WHEN ((d.terminal & (3)::bigint) = 1) THEN 'completed'::text
                    WHEN ((d.terminal & (3)::bigint) = 2) THEN 'failed'::text
                    WHEN ((d.terminal IS NOT NULL) OR ((d.flags & 8) > 0)) THEN 'unknown'::text
                    WHEN ((d.flags & 4) > 0) THEN 'nonterminal'::text
                    ELSE 'unknown'::text
                END AS status
           FROM uk.search_analytics_daily_journeys d
          WHERE (NOT (EXISTS ( SELECT 1
                   FROM uk.search_analytics_repeated_journey_keys k
                  WHERE ((k.service = d.service) AND (k.journey_key = d.journey_key)))))
        )
 SELECT single_day.service,
    single_day.reporting_date,
    v.view,
    'day'::text AS bucket_size,
    (single_day.reporting_date)::timestamp without time zone AS bucket,
    single_day.status,
    single_day.flags
   FROM (single_day
     CROSS JOIN LATERAL ( VALUES ('all'::text,single_day.all_hours), ('classic'::text,single_day.classic_hours), ('internal'::text,single_day.internal_hours)) v(view, hours))
  WHERE (v.hours > 0)
UNION ALL
 SELECT single_day.service,
    single_day.reporting_date,
    v.view,
    'hour'::text AS bucket_size,
    ((single_day.reporting_date)::timestamp without time zone + make_interval(hours => h.h)) AS bucket,
    single_day.status,
    single_day.flags
   FROM ((single_day
     CROSS JOIN LATERAL ( VALUES ('all'::text,single_day.all_hours), ('classic'::text,single_day.classic_hours), ('internal'::text,single_day.internal_hours)) v(view, hours))
     CROSS JOIN generate_series(0, 23) h(h))
  WHERE ((v.hours & ((1)::bigint << h.h)) > 0);


--
-- Name: search_analytics_journey_rollup_totals; Type: MATERIALIZED VIEW; Schema: uk; Owner: -
--

CREATE MATERIALIZED VIEW uk.search_analytics_journey_rollup_totals AS
 SELECT service,
    reporting_date,
    view,
    bucket_size,
    ...
    count(*) FILTER (WHERE (status = 'nonterminal'::text)) AS nonterminal,
   ...
   FROM uk.search_analytics_journey_rollup_rows
  GROUP BY service, reporting_date, view, bucket_size, bucket
  WITH NO DATA;

--
-- Name: search_analytics_repeated_journeys; Type: MATERIALIZED VIEW; Schema: uk; Owner: -
--

CREATE MATERIALIZED VIEW uk.search_analytics_repeated_journeys AS
 SELECT d.service,
    d.reporting_date,
    d.journey_key,
    d.all_hours,
    ...
    d.flags
   FROM (uk.search_analytics_daily_journeys d
     JOIN uk.search_analytics_repeated_journey_keys k USING (service, journey_key))
  WITH NO DATA;

--
-- Name: search_analytics_source_revisions; Type: MATERIALIZED VIEW; Schema: uk; Owner: -
--

CREATE MATERIALIZED VIEW uk.search_analytics_source_revisions AS
 SELECT id,
    service,
    reporting_date,
    name,
  ...
  WHERE (name = ANY (ARRAY['search_journeys'::text, 'journey_outcomes'::text]))
  WITH NO DATA;
...
--
-- Name: evaluation_gold_queries; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.evaluation_gold_queries (
    id integer NOT NULL,
...
--
-- Name: evaluation_gold_queries_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.evaluation_gold_queries ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.evaluation_gold_queries_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: search_export_journeys; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.search_export_journeys (
    id integer NOT NULL,
    request_id text NOT NULL,
    service text NOT NULL,
    request_source text NOT NULL,
    query text NOT NULL,
    expansion_terms jsonb DEFAULT '[]'::jsonb NOT NULL,
...
--
-- Name: search_export_journeys_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.search_export_journeys ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.search_export_journeys_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: search_export_result_clicks; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.search_export_result_clicks (
    id integer NOT NULL,
    request_id text NOT NULL,
...
--
-- Name: search_export_result_clicks_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.search_export_result_clicks ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.search_export_result_clicks_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: search_export_workbooks; Type: TABLE; Schema: uk; Owner: -
--

CREATE TABLE uk.search_export_workbooks (
    id integer NOT NULL,
    service text NOT NULL,
...
--
-- Name: search_export_workbooks_id_seq; Type: SEQUENCE; Schema: uk; Owner: -
--

ALTER TABLE uk.search_export_workbooks ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME uk.search_export_workbooks_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: search_analytics_query_results search_analytics_query_results_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.search_analytics_query_results
    ADD CONSTRAINT search_analytics_query_results_pkey PRIMARY KEY (id);
...
--
-- Name: evaluation_gold_queries evaluation_gold_queries_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.evaluation_gold_queries
    ADD CONSTRAINT evaluation_gold_queries_pkey PRIMARY KEY (id);
...
--
-- Name: search_export_journeys search_export_journeys_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.search_export_journeys
    ADD CONSTRAINT search_export_journeys_pkey PRIMARY KEY (id);


--
-- Name: search_export_journeys search_export_journeys_request_id_key; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.search_export_journeys
    ADD CONSTRAINT search_export_journeys_request_id_key UNIQUE (request_id);


--
-- Name: search_export_result_clicks search_export_result_clicks_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.search_export_result_clicks
    ADD CONSTRAINT search_export_result_clicks_pkey PRIMARY KEY (id);


--
-- Name: search_export_workbooks search_export_workbooks_pkey; Type: CONSTRAINT; Schema: uk; Owner: -
--

ALTER TABLE ONLY uk.search_export_workbooks
    ADD CONSTRAINT search_export_workbooks_pkey PRIMARY KEY (id);
...
--
-- Name: idx_search_analytics_daily_query; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX idx_search_analytics_daily_query ON uk.search_analytics_query_results USING btree (service, reporting_date, name);


--
-- Name: search_analytics_daily_journeys_identity; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX search_analytics_daily_journeys_identity ON uk.search_analytics_daily_journeys USING btree (service, reporting_date, journey_key);


--
-- Name: search_analytics_journey_rollup_totals_identity; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX search_analytics_journey_rollup_totals_identity ON uk.search_analytics_journey_rollup_totals USING btree (service, reporting_date, view, bucket_size, bucket);


--
-- Name: search_analytics_repeated_journeys_identity; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX search_analytics_repeated_journeys_identity ON uk.search_analytics_repeated_journeys USING btree (service, reporting_date, journey_key);

--
-- Name: search_analytics_source_revisions_identity; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX search_analytics_source_revisions_identity ON uk.search_analytics_source_revisions USING btree (service, reporting_date, name);
...
--
-- Name: evaluation_gold_queries_expected_code_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX evaluation_gold_queries_expected_code_index ON uk.evaluation_gold_queries USING btree (expected_code);


--
-- Name: evaluation_gold_queries_source_persona_uidx; Type: INDEX; Schema: uk; Owner: -
--

CREATE UNIQUE INDEX evaluation_gold_queries_source_persona_uidx ON uk.evaluation_gold_queries USING btree (source_type, source_id, persona);
...
--
-- Name: search_export_result_clicks_request_id_clicked_at_index; Type: INDEX; Schema: uk; Owner: -
--

CREATE INDEX search_export_result_clicks_request_id_clicked_at_index ON uk.search_export_result_clicks USING btree (request_id, clicked_at);
...
INSERT INTO "schema_migrations" ("filename") VALUES ('20260924120000_create_search_export_tables.rb');
