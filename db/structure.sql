...
--
-- Name: user_data_exports user_data_exports_user_subscriptions_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_data_exports
    ADD CONSTRAINT user_data_exports_user_subscriptions_uuid_fkey FOREIGN KEY (user_subscriptions_uuid) REFERENCES public.user_subscriptions(uuid);
...
INSERT INTO "schema_migrations" ("filename") VALUES ('20260303113514_create_user_data_exports.rb');