RSpec.describe GenerateSelfText::BaseSelfTextBuilder do
  ...
  describe '#call' do
    subject(:result) { GenerateSelfText::OtherSelfTextBuilder.call(chapter) }
    ...
    describe 'skip logic' do
      it 'skips records whose context hash and freshness have not changed' do
        ...
        second_result = GenerateSelfText::OtherSelfTextBuilder.call(chapter)
      ...
      it 'clears approval and review state when regenerated by the pipeline' do
        GenerateSelfText::OtherSelfTextBuilder.call(chapter)
        record = GoodsNomenclatureSelfText[other_commodity.goods_nomenclature_sid]
        record.update(stale: true, needs_review: true, approved: true)
    ...
    describe 'paper trail' do
      ...
      it 'creates an update version when regeneration changes an existing self-text' do
        ...
        expect { GenerateSelfText::OtherSelfTextBuilder.call(chapter) }.to change(Version, :count).by(1)
