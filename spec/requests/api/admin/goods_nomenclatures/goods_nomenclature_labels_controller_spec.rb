RSpec.describe Api::Admin::GoodsNomenclatures::GoodsNomenclatureLabelsController do
  describe '#show' do
    ...
    context 'when goods nomenclature label is present' do
      ...
      it 'returns api_response record' do
        get "/uk/admin/goods_nomenclatures/#{commodity.goods_nomenclature_item_id}/goods_nomenclature_label.json", headers: request_headers(format: :json)
    ...
    context 'when goods nomenclature does not exist' do
      it 'returns not found' do
        get '/uk/admin/goods_nomenclatures/9999999999/goods_nomenclature_label.json', headers: request_headers(format: :json)
  ...
  describe '#update' do
    ...
    context 'when save succeeded' do
      ...
      it 'responds with success' do
        put "/uk/admin/goods_nomenclatures/#{commodity.goods_nomenclature_item_id}/goods_nomenclature_label.json", params: { data: { type: 'goods_nomenclature_label', attributes: { labels: new_labels } } }, headers: request_headers(format: :json), as: :json
    ...
    context 'when updating label suggestions' do
      ...
      it 'removes old label suggestions when terms are deleted' do
        ...
        put "/uk/admin/goods_nomenclatures/#{commodity.goods_nomenclature_item_id}/goods_nomenclature_label.json", params: { data: { type: 'goods_nomenclature_label', attributes: { labels: empty_labels } } }, headers: request_headers(format: :json), as: :json
    ...
    context 'when goods nomenclature does not exist' do
      it 'returns 404' do
        put '/uk/admin/goods_nomenclatures/9999999999/goods_nomenclature_label.json', params: { data: { type: 'goods_nomenclature_label', attributes: { labels: { description: 'test' } } } }, headers: request_headers(format: :json), as: :json
    ...
    context 'when goods nomenclature label does not exist' do
      ...
      it 'returns 404' do
        put "/uk/admin/goods_nomenclatures/#{commodity_without_label.goods_nomenclature_item_id}/goods_nomenclature_label.json", params: { data: { type: 'goods_nomenclature_label', attributes: { labels: { description: 'test' } } } }, headers: request_headers(format: :json), as: :json
    ...
    context 'when save fails' do
      it 'returns 422 without reindexing or enqueueing scoring' do
        ...
        label_dataset = instance_double(Sequel::Dataset, first: label)

        allow(GoodsNomenclatureLabel).to receive(:where).and_call_original
        allow(GoodsNomenclatureLabel)
          .to receive(:where)
          .with(goods_nomenclature_item_id: commodity.goods_nomenclature_item_id)
          .and_return(label_dataset)
        allow(label)
          .to receive(:save)
        ...
        put "/uk/admin/goods_nomenclatures/#{commodity.goods_nomenclature_item_id}/goods_nomenclature_label.json", params: { data: {
          type: 'goods_nomenclature_label',
  ...
  describe '#show with version browsing' do
    ...
    context 'when viewing a historical version via filter[oid]' do
      ...
      it 'returns the historical version data' do
        ...
        get "/uk/admin/goods_nomenclatures/#{commodity.goods_nomenclature_item_id}/goods_nomenclature_label.json", params: { filter: { oid: version.id } }, headers: request_headers(format: :json)
    ...
    context 'when version does not exist' do
      it 'returns 404' do
        get "/uk/admin/goods_nomenclatures/#{commodity.goods_nomenclature_item_id}/goods_nomenclature_label.json", params: { filter: { oid: 999_999 } }, headers: request_headers(format: :json)
  ...
  describe '#versions' do
    ...
    it 'returns versions for the label' do
      ...
      get "/uk/admin/goods_nomenclatures/#{commodity.goods_nomenclature_item_id}/goods_nomenclature_label/versions.json", headers: request_headers(format: :json)
    ...
    context 'when label does not exist' do
      it 'returns 404' do
        get '/uk/admin/goods_nomenclatures/9999999999/goods_nomenclature_label/versions.json', headers: request_headers(format: :json)
  ...
  describe '#approve' do
    ...
    it 'approves the label and clears review' do
      post "/uk/admin/goods_nomenclatures/#{commodity.goods_nomenclature_item_id}/goods_nomenclature_label/approve.json", headers: request_headers(format: :json), as: :json
  ...
  describe '#reject' do
    ...
    it 'marks the label for review and clears approval' do
      post "/uk/admin/goods_nomenclatures/#{commodity.goods_nomenclature_item_id}/goods_nomenclature_label/reject.json", headers: request_headers(format: :json), as: :json
  ...
  describe '#score' do
    ...
    it 'scores the label without changing review state' do
      post "/uk/admin/goods_nomenclatures/#{commodity.goods_nomenclature_item_id}/goods_nomenclature_label/score.json", headers: request_headers(format: :json), as: :json
  ...
  describe '#regenerate' do
    ...
    it 'replaces the label and clears lifecycle review tags' do
      post "/uk/admin/goods_nomenclatures/#{commodity.goods_nomenclature_item_id}/goods_nomenclature_label/regenerate.json", headers: request_headers(format: :json), as: :json
