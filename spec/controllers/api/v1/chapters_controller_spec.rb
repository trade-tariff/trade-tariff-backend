RSpec.describe Api::V1::ChaptersController, 'GET #show' do
  render_views
...
RSpec.describe Api::V1::ChaptersController, 'GET #index' do
  render_views
...
RSpec.describe Api::V1::ChaptersController, 'GET #changes' do
  render_views
