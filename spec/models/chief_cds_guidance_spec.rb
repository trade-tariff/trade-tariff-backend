...
RSpec.describe ChiefCdsGuidance do
  describe '#cds_guidance_for' do
    ...
    it_behaves_like 'a correct cds guidance result', 'foo', 'No information currently available'
  ...
  describe '#chief_guidance_for' do
    ...
    it_behaves_like 'a correct cds guidance result', 'A001', "- Use status code AC.\n\n"
    it_behaves_like 'a correct cds guidance result', 'A007', 'No information currently available'
    it_behaves_like 'a correct cds guidance result', 'foo', 'No information currently available'
    it_behaves_like 'a correct cds guidance result', '', nil
    it_behaves_like 'a correct cds guidance result', nil, nil
  end
