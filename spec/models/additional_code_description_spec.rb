RSpec.describe AdditionalCodeDescription do
  describe '.with_fuzzy_description' do
    subject(:with_fuzzy_description) { described_class.with_fuzzy_description(description) }

    before do
      create :additional_code_description, description: 'VAT 20%'
      create :additional_code_description, description: 'VAT 10%'
      create :additional_code_description, description: 'VAT 5%'
      create :additional_code_description, description: 'Excise 5%'
    end
