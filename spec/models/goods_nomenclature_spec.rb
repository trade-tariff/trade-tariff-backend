RSpec.describe GoodsNomenclature do
  ...
  describe 'ordering', :flaky do
    ...
    before do
      create(:commodity, producline_suffix: GoodsNomenclature::NON_GROUPING_PRODUCTLINE_SUFFIX, goods_nomenclature_item_id: '0101210000')
      create(:heading, producline_suffix: GoodsNomenclature::NON_GROUPING_PRODUCTLINE_SUFFIX, goods_nomenclature_item_id: '0102000000')
      create(:chapter, producline_suffix: GoodsNomenclature::NON_GROUPING_PRODUCTLINE_SUFFIX, goods_nomenclature_item_id: '0100000000')
      create(:heading, producline_suffix: GoodsNomenclature::NON_GROUPING_PRODUCTLINE_SUFFIX, goods_nomenclature_item_id: '0101000000')
      create(:commodity, producline_suffix: '10', goods_nomenclature_item_id: '0101210000')
    end

    let(:expected_goods_nomenclatures) do
      [
        ['0100000000', GoodsNomenclature::NON_GROUPING_PRODUCTLINE_SUFFIX],
        ['0101000000', GoodsNomenclature::NON_GROUPING_PRODUCTLINE_SUFFIX],
        %w[0101210000 10], # Included producline suffix in composite ordering
        ['0101210000', GoodsNomenclature::NON_GROUPING_PRODUCTLINE_SUFFIX],
        ['0102000000', GoodsNomenclature::NON_GROUPING_PRODUCTLINE_SUFFIX],
      ]
    end
  ...
  describe '.with_footnote_types_and_ids' do
    ...
    context 'when footnote_types_and_ids is empty' do
      ...
      it { expect(dataset.pluck(:footnote_id)).to match_array(%w[123 456 789]) }
      it { expect(dataset.pluck(:footnote_type_id)).to match_array(%w[Y N Z]) }
    end
    ...
    context 'when footnote_types_and_ids is present' do
      ...
      it { expect(dataset.pluck(:footnote_id)).to match_array(%w[123 456]) }
      it { expect(dataset.pluck(:footnote_type_id)).to match_array(%w[Y N]) }
    end
  end
