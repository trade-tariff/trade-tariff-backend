RSpec.describe FootnoteDescription do
  describe '.with_fuzzy_description' do
    subject(:with_fuzzy_description) { described_class.with_fuzzy_description(description) }

    before do
      create :footnote_description, description: 'VAT 20%'
      create :footnote_description, description: 'VAT 10%'
      create :footnote_description, description: 'VAT 5%'
      create :footnote_description, description: 'Excise 5%'
    end
