module SearchDiagnostics
  class RequestLogLookup
    ...
    def cloudwatch_query
      <<~QUERY
        fields @timestamp, @message, event, request_id, search_type, query, base_query, effective_query, original_query, expanded_query, refined_query, added_answers, reason, result_count, max_score, total_duration_ms, duration_ms, leg, status, retrieval_method, stage, iteration, match_source, matched_value, target_type, target_id, target_endpoint, goods_nomenclature_item_id, goods_nomenclature_sid, goods_nomenclature_class, model, response_type, attempt_number, question_count, answer_count, confidence_levels, final_result_type, results_type, total_attempts, total_questions, error_type, error_message, error_message_truncated, details, description_intercept_matched, description_intercept_term, description_intercept_excluded, description_intercept_filtering, description_intercept_filter_prefix_count, description_intercept_guidance_level, description_intercept_guidance_location, description_intercept_escalate_to_webchat, matched, term, excluded, filtering, filter_prefix_count, guidance_level, guidance_location, escalate_to_webchat
