class DeltaReportService
  class FootnoteAssociationMeasureChanges < BaseChanges
    def self.collect(date)
      ...
      FootnoteAssociationMeasure.operation_klass
    ...
    def analyze
      ...
      return if record.operation == :create && Footnote.operation_klass.where(footnote_type_id: record.footnote_type_id, footnote_id: record.footnote_id, operation_date: record.operation_date).any?
