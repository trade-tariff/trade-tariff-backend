...
module_function
  ...
  def merge_metadata(left, right)
    ...
    Metadata.new(
      ...
      cached_input_tokens: sum_optional(left.cached_input_tokens, right.cached_input_tokens),
      cache_write_input_tokens: sum_optional(left.cache_write_input_tokens, right.cache_write_input_tokens),
