      ...
      batch.each do |attributes|
        ...
        attributes['MeursingTablePlan']['meursingHeading'].each do |heading|
          ...
          meursing_headings.push({
                                   meursing_table_plan_id: attributes.dig('MeursingTablePlan', 'meursingTablePlanId'),
                                   meursing_heading_number: heading.dig('meursingHeadingNumber'),
                                   row_column_code: heading.dig('rowColumnCode'),
                                   validity_start_date: heading.dig('validityStartDate'),
                                   validity_end_date: heading.dig('validityEndDate'),
          ...
          heading['meursingSubheading'].each do |subheading|
            ...
            meursing_subheadings.push({
                         ...
                         meursing_heading_number: heading.dig('meursingHeadingNumber'),
                         row_column_code: heading.dig('rowColumnCode'),
                         subheading_sequence_number: subheading.dig('subheadingSequenceNumber'),
                         description: subheading.dig('description'),
