module GoodsNomenclatures
  module NestedSet
    module DescendantAssociations
      ...
      included do
        register_descendants_association
        register_children_association
        register_historical_children_association
      end

      module ClassMethods
        def register_descendants_association
        ...
        def register_children_association
        ...
        def register_historical_children_association
