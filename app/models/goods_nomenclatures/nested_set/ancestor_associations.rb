module GoodsNomenclatures
  module NestedSet
    module AncestorAssociations
      ...
      included do
        register_tree_node_association
        register_ancestors_association
        register_parent_association
      end

      module ClassMethods
        def register_tree_node_association
        ...
        def register_ancestors_association
        ...
        def register_parent_association
