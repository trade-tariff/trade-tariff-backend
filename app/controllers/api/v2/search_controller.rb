    ...
    class SearchController < ApiController
      ...
      def suggestions
        ...
        if TradeTariffBackend.optimised_search_enabled?
          results = ElasticSearch::ElasticSearchService.new(params).to_suggestions
        else
      ...
      def log_search_results(query, results)
        ...
        max_score = [
          commodity_score, chapter_score, heading_score, section_score,
          ref_commodity_score, ref_chapter_score, ref_heading_score, ref_section_score
        ].max
