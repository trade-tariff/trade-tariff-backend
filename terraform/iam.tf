data "aws_iam_policy_document" "secrets" {
  statement {
    ...
    resources = [
      ...
      data.aws_secretsmanager_secret.otel_exporter.arn,
      data.aws_secretsmanager_secret.otel_exporter_otlp_endpoint.arn,
      data.aws_secretsmanager_secret.otel_exporter_otlp_headers.arn,
      data.aws_secretsmanager_secret.otel_service_name.arn,
      ...
      data.aws_secretsmanager_secret.scout_api_key.arn,
