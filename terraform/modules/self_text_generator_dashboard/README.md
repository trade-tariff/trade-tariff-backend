...
| Name | Type |
|------|------|
| [aws_cloudwatch_dashboard.self_text_generator](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudwatch_dashboard) | resource |
...
| <a name="input_log_group_name"></a> [log\_group\_name](#input\_log\_group\_name) | CloudWatch Log Group name where self-text generator logs are sent | `string` | n/a | yes |
...
| <a name="output_metric_namespace"></a> [metric\_namespace](#output\_metric\_namespace) | CloudWatch metric namespace for self-text generator metrics |
<!-- END_TF_DOCS -->
