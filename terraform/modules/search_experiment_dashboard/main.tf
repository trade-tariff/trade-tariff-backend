      ...
      [
        {
          ...
          properties = {
            markdown = join("\n", [
              ...
              "**Product zeros:** classic = fuzzy/null with zero commodity hits (empty Best commodity matches); interactive/internal = no returned results. Shared widgets break series down by `search_type` where relevant.",
