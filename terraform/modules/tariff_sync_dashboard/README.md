...
| Name | Type |
|------|------|
| [aws_cloudwatch_dashboard.tariff_sync](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudwatch_dashboard) | resource |
...
| <a name="input_log_group_name"></a> [log\_group\_name](#input\_log\_group\_name) | CloudWatch Log Group name where tariff sync logs are sent | `string` | n/a | yes |
